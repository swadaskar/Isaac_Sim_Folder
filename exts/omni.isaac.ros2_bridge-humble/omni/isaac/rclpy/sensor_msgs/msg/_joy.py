    ...
    def axes(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'axes' field must be a set or sequence and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
