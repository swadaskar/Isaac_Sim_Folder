...
class DisparityImage(metaclass=Metaclass_DisparityImage):
    ...
    def min_disparity(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'min_disparity' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def max_disparity(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'max_disparity' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def delta_d(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'delta_d' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._delta_d = value
