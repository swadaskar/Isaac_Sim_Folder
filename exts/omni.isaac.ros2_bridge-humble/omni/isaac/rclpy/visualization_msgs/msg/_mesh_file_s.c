...
bool visualization_msgs__msg__mesh_file__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("visualization_msgs.msg._mesh_file.MeshFile", full_classname_dest, 42) == 0);
  }
  visualization_msgs__msg__MeshFile * ros_message = _ros_message;
  {  // filename
...
{
  /* NOTE(esteve): Call constructor of MeshFile */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("visualization_msgs.msg._mesh_file");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MeshFile");
  ...
  visualization_msgs__msg__MeshFile * ros_message = (visualization_msgs__msg__MeshFile *)raw_ros_message;
  {  // filename
    PyObject * field = NULL;
