...
class OgnROS2PublishLaserScanDatabase(og.Database):
    ...
    class ValuesForInputs(og.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES = {"azimuthRange", "context", "depthRange", "execIn", "frameId", "horizontalFov", "horizontalResolution", "nodeNamespace", "numCols", "numRows", "queueSize", "rotationRate", "timeStamp", "topicName", "_setting_locked", "_batchedReadAttributes", "_batchedReadValues"}
        ...
        def __init__(self, node: og.Node, attributes, dynamic_attributes: og.DynamicAttributeInterface):
            ...
            self._batchedReadValues = [[0.0, 0.0], 0, [0, 0], None, "sim_lidar", 0, 0, "", 0, 0, 10, 0, 0.0, "scan"]
