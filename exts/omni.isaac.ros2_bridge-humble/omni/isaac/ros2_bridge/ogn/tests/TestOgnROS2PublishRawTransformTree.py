...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishRawTransformTreeDatabase import OgnROS2PublishRawTransformTreeDatabase
        ...
        database = OgnROS2PublishRawTransformTreeDatabase(test_node)
        ...
        db_value = database.inputs.childFrameId
        ...
        db_value = database.inputs.parentFrameId
        expected_value = "odom"
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ogts.verify_values(expected_value, db_value, _attr_error(attribute, False))
