...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishOdometryDatabase import OgnROS2PublishOdometryDatabase
        ...
        database = OgnROS2PublishOdometryDatabase(test_node)
        ...
        db_value = database.inputs.chassisFrameId
        ...
        db_value = database.inputs.odomFrameId
        expected_value = "odom"
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ogts.verify_values(expected_value, db_value, _attr_error(attribute, False))
        ...
        db_value = database.inputs.orientation
        ...
        db_value = database.inputs.robotFront
