...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishJointStateDatabase import OgnROS2PublishJointStateDatabase
        ...
        database = OgnROS2PublishJointStateDatabase(test_node)
        ...
        db_value = database.inputs.targetPrim
