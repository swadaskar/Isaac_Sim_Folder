...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishPointCloudDatabase import OgnROS2PublishPointCloudDatabase
        ...
        database = OgnROS2PublishPointCloudDatabase(test_node)
