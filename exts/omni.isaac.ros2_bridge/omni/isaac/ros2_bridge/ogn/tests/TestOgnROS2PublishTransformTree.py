...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishTransformTreeDatabase import OgnROS2PublishTransformTreeDatabase
        ...
        database = OgnROS2PublishTransformTreeDatabase(test_node)
        ...
        db_value = database.inputs.targetPrims
