...
bool test_msgs__msg__unbounded_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._unbounded_sequences.UnboundedSequences", full_classname_dest, 53) == 0);
  }
  test_msgs__msg__UnboundedSequences * ros_message = _ros_message;
  {  // bool_values
  ...
  {  // basic_types_values
    ...
    if (!test_msgs__msg__BasicTypes__Sequence__init(&(ros_message->basic_types_values), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create test_msgs__msg__BasicTypes__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    test_msgs__msg__BasicTypes * dest = ros_message->basic_types_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // constants_values
    ...
    if (!test_msgs__msg__Constants__Sequence__init(&(ros_message->constants_values), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create test_msgs__msg__Constants__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    test_msgs__msg__Constants * dest = ros_message->constants_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // defaults_values
    ...
    if (!test_msgs__msg__Defaults__Sequence__init(&(ros_message->defaults_values), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create test_msgs__msg__Defaults__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    test_msgs__msg__Defaults * dest = ros_message->defaults_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * test_msgs__msg__unbounded_sequences__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_msgs.msg._unbounded_sequences");
  ...
  test_msgs__msg__UnboundedSequences * ros_message = (test_msgs__msg__UnboundedSequences *)raw_ros_message;
  {  // bool_values
    PyObject * field = NULL;
