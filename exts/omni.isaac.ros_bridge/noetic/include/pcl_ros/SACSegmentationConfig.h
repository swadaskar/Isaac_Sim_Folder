...
namespace pcl_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(SACSegmentationConfig &config, const SACSegmentationConfig &max, const SACSegmentationConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const SACSegmentationConfig &config1, const SACSegmentationConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, SACSegmentationConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const SACSegmentationConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, SACSegmentationConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const SACSegmentationConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const SACSegmentationConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, SACSegmentationConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
