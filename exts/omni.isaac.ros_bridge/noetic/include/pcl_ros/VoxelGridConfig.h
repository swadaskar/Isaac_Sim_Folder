...
namespace pcl_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(VoxelGridConfig &config, const VoxelGridConfig &max, const VoxelGridConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const VoxelGridConfig &config1, const VoxelGridConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, VoxelGridConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const VoxelGridConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, VoxelGridConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const VoxelGridConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const VoxelGridConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, VoxelGridConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
  ...
  public:
    ...
    void setParams(VoxelGridConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("min_points_per_voxel"==(*_i)->name){min_points_per_voxel = boost::any_cast<int>(val);}
...
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.min_points_per_voxel = 1;
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.min_points_per_voxel = 100000;
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.min_points_per_voxel = 1;
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VoxelGridConfig::AbstractParamDescriptionConstPtr(new VoxelGridConfig::ParamDescription<int>("min_points_per_voxel", "int", 0, "The minimum number of points required for a voxel to be used.", "", &VoxelGridConfig::min_points_per_voxel)));
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(VoxelGridConfig::AbstractParamDescriptionConstPtr(new VoxelGridConfig::ParamDescription<int>("min_points_per_voxel", "int", 0, "The minimum number of points required for a voxel to be used.", "", &VoxelGridConfig::min_points_per_voxel)));
//#line 291 "/workspace/noetic_ws/install/lib/python3.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
