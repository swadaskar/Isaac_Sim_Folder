...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /workspace/noetic_ws/src/urdf/urdf)
  set(urdf_DEVEL_PREFIX /workspace/noetic_ws/devel/urdf)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /workspace/noetic_ws/install)
...
if(NOT "include;/usr/local/lib/urdfdom_headers/cmake/../../../include/urdfdom_headers;/usr/local/lib/urdfdom/cmake/../../../include/urdfdom;/usr/local/include;/workspace/boost_1_68_0/_install/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/lib/urdfdom_headers/cmake/../../../include/urdfdom_headers;/usr/local/lib/urdfdom/cmake/../../../include/urdfdom;/usr/local/include;/workspace/boost_1_68_0/_install/include")
...
set(libraries "urdf;/usr/local/lib/liburdfdom_sensor.so;/usr/local/lib/liburdfdom_model_state.so;/usr/local/lib/liburdfdom_model.so;/usr/local/lib/liburdfdom_world.so;/usr/local/lib/libconsole_bridge.so.1.0;/workspace/boost_1_68_0/_install/lib/libboost_thread.so;-lpthread;/workspace/boost_1_68_0/_install/lib/libboost_chrono.so;/workspace/boost_1_68_0/_install/lib/libboost_system.so;/workspace/boost_1_68_0/_install/lib/libboost_date_time.so;/workspace/boost_1_68_0/_install/lib/libboost_atomic.so;/usr/local/lib/libtinyxml.so;/usr/local/lib/libtinyxml2.a")
