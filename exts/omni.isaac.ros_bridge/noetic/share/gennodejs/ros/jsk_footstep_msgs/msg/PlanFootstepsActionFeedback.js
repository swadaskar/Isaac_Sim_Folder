...
class PlanFootstepsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlanFootstepsFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlanFootstepsActionFeedback
    ...
    bufferOffset = PlanFootstepsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlanFootstepsActionFeedback
    let len;
    let data = new PlanFootstepsActionFeedback(null);
    ...
    data.feedback = PlanFootstepsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanFootstepsFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanFootstepsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlanFootstepsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlanFootstepsFeedback()
    }
...
module.exports = PlanFootstepsActionFeedback;
