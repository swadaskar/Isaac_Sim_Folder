...
class BoundingBoxArrayWithCameraInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('boxes')) {
        ...
        this.boxes = new BoundingBoxArray();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BoundingBoxArrayWithCameraInfo
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [boxes]
    bufferOffset = BoundingBoxArray.serialize(obj.boxes, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BoundingBoxArrayWithCameraInfo
    let len;
    let data = new BoundingBoxArrayWithCameraInfo(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [boxes]
    data.boxes = BoundingBoxArray.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += BoundingBoxArray.getMessageSize(object.boxes);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BoundingBoxArrayWithCameraInfo(null);
    ...
    if (msg.boxes !== undefined) {
      resolved.boxes = BoundingBoxArray.Resolve(msg.boxes)
    }
    else {
      resolved.boxes = new BoundingBoxArray()
    }
...
module.exports = BoundingBoxArrayWithCameraInfo;
