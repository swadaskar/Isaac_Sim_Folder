...
class PosedCameraInfo {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PosedCameraInfo
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PosedCameraInfo
    let len;
    let data = new PosedCameraInfo(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PosedCameraInfo(null);
...
module.exports = PosedCameraInfo;
