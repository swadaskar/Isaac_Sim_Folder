...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros_bridge.ogn.OgnROS1PublishLaserScanDatabase import OgnROS1PublishLaserScanDatabase
        ...
        database = OgnROS1PublishLaserScanDatabase(test_node)
