...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros_bridge.ogn.OgnROS1PublishPointCloudDatabase import OgnROS1PublishPointCloudDatabase
        ...
        database = OgnROS1PublishPointCloudDatabase(test_node)
