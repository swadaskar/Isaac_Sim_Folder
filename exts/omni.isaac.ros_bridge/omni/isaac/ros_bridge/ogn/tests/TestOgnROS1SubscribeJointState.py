...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros_bridge.ogn.OgnROS1SubscribeJointStateDatabase import OgnROS1SubscribeJointStateDatabase
        ...
        database = OgnROS1SubscribeJointStateDatabase(test_node)
