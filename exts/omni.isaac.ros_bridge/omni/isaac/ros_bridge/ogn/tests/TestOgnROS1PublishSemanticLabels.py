...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros_bridge.ogn.OgnROS1PublishSemanticLabelsDatabase import OgnROS1PublishSemanticLabelsDatabase
        ...
        database = OgnROS1PublishSemanticLabelsDatabase(test_node)
