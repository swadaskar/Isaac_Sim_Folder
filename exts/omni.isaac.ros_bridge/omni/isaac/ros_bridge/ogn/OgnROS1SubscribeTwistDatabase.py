"""Support for simplified access to data on nodes of type omni.isaac.ros_bridge.ROS1SubscribeTwist
...
import numpy
import carb
class OgnROS1SubscribeTwistDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type omni.isaac.ros_bridge.ROS1SubscribeTwist
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:topicName', 'string', 0, None, 'Name of ROS1 Topic', {ogn.MetadataKeys.DEFAULT: '"cmd_vel"'}, True, 'cmd_vel', False, ''),
    ...
    class ValuesForInputs(og.DynamicAttributeAccess):
        ...
        def __init__(self, node: og.Node, attributes, dynamic_attributes: og.DynamicAttributeInterface):
            ...
            self._batchedReadValues = [None, "", 10, "cmd_vel"]
    ...
    def __init__(self, node):
        ...
        self.inputs = OgnROS1SubscribeTwistDatabase.ValuesForInputs(node, self.attributes.inputs, dynamic_attributes)
        dynamic_attributes = self.dynamic_attribute_data(node, og.AttributePortType.ATTRIBUTE_PORT_TYPE_OUTPUT)
        self.outputs = OgnROS1SubscribeTwistDatabase.ValuesForOutputs(node, self.attributes.outputs, dynamic_attributes)
        dynamic_attributes = self.dynamic_attribute_data(node, og.AttributePortType.ATTRIBUTE_PORT_TYPE_STATE)
        self.state = OgnROS1SubscribeTwistDatabase.ValuesForState(node, self.attributes.state, dynamic_attributes)
