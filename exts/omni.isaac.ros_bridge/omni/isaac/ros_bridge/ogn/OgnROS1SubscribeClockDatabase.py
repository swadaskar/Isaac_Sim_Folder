"""Support for simplified access to data on nodes of type omni.isaac.ros_bridge.ROS1SubscribeClock
...
import carb
class OgnROS1SubscribeClockDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type omni.isaac.ros_bridge.ROS1SubscribeClock
    ...
    class ValuesForInputs(og.DynamicAttributeAccess):
        ...
        def __init__(self, node: og.Node, attributes, dynamic_attributes: og.DynamicAttributeInterface):
            ...
            self._batchedReadValues = [None, "", 10, "clock"]
    ...
    def __init__(self, node):
        ...
        self.inputs = OgnROS1SubscribeClockDatabase.ValuesForInputs(node, self.attributes.inputs, dynamic_attributes)
        dynamic_attributes = self.dynamic_attribute_data(node, og.AttributePortType.ATTRIBUTE_PORT_TYPE_OUTPUT)
        self.outputs = OgnROS1SubscribeClockDatabase.ValuesForOutputs(node, self.attributes.outputs, dynamic_attributes)
        dynamic_attributes = self.dynamic_attribute_data(node, og.AttributePortType.ATTRIBUTE_PORT_TYPE_STATE)
        self.state = OgnROS1SubscribeClockDatabase.ValuesForState(node, self.attributes.state, dynamic_attributes)
