...
class OgnROS1RtxLidarHelperDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ('inputs:context', 'uint64', 0, None, 'ROS context handle, default of zero will use the global context', {ogn.MetadataKeys.DEFAULT: '0'}, True, 0, False, ''),
        ('inputs:execIn', 'execution', 0, None, 'Triggering this causes the sesnor pipeline to be generated', {}, True, None, False, ''),
        ('inputs:frameId', 'string', 0, None, 'FrameID for the ROS1 message', {ogn.MetadataKeys.DEFAULT: '"sim_lidar"'}, True, 'sim_lidar', False, ''),
