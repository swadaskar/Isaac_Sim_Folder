...
class TestRotatingLidarRtx(omni.kit.test.AsyncTestCase):
    ...
    async def setUp(self):
        ...
        self.xform = self.my_world.scene.add(
            XFormPrim(prim_path="/World/Carter/chassis_link/stereo_cam_right/lidar_rig", name="rig")
        )
        self._my_lidar = self.my_world.scene.add(
            LidarRtx(prim_path="/World/Carter/chassis_link/stereo_cam_right/lidar_rig/lidar", name="lidar")
        )
