...
class OgnIsaacReadContactSensorDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ('inputs:csPrim', 'bundle', 0, 'Contact Sensor Prim', 'USD prim reference to contact sensor prim', {}, True, None, False, ''),
    ...
    def _populate_role_data(cls):
        ...
        role_data.inputs.csPrim = og.Database.ROLE_BUNDLE
    ...
    class ValuesForInputs(og.DynamicAttributeAccess):
        ...
        @property
        def csPrim(self) -> og.BundleContents:
            """Get the bundle wrapper class for the attribute inputs.csPrim"""
            return self.__bundles.csPrim
    ...
    class ValuesForOutputs(og.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES = {"execOut", "inContact", "value", "_batchedWriteValues"}
