...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.core_nodes.ogn.OgnIsaacReadSimulationTimeDatabase import OgnIsaacReadSimulationTimeDatabase
        ...
        database = OgnIsaacReadSimulationTimeDatabase(test_node)
        ...
        db_value = database.inputs.resetOnStop
