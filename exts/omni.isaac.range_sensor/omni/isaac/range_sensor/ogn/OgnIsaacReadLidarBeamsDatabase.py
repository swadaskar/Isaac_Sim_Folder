...
class OgnIsaacReadLidarBeamsDatabase(og.Database):
    ...
    class ValuesForOutputs(og.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES = {"azimuthRange", "depthRange", "execOut", "horizontalFov", "horizontalResolution", "numCols", "numRows", "rotationRate", "verticalFov", "verticalResolution", "zenithRange", "_batchedWriteValues"}
        ...
        def verticalFov(self):
            value = self._batchedWriteValues.get(self._attributes.verticalFov)
            if value:
                return value
            else:
        ...
        def verticalFov(self, value):
            self._batchedWriteValues[self._attributes.verticalFov] = value

        @property
        def verticalResolution(self):
            value = self._batchedWriteValues.get(self._attributes.verticalResolution)
            if value:
                return value
            else:
        ...
        def verticalResolution(self, value):
            self._batchedWriteValues[self._attributes.verticalResolution] = value

        @property
        def zenithRange(self):
            value = self._batchedWriteValues.get(self._attributes.zenithRange)
            if value:
                return value
            else:
        ...
        def zenithRange(self, value):
            self._batchedWriteValues[self._attributes.zenithRange] = value
