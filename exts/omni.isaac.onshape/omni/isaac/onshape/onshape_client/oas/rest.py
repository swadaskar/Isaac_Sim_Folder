...
# Ethan added
from omni.isaac.onshape.onshape_client.apikey_headers import add_onshape_specific_headers
from omni.isaac.onshape.onshape_client.oas.exceptions import ApiException, ApiValueError
...
class RESTClientObject(object):
    ...
    def request(
        ...
        if get_client().get_authentication_method() == "api_keys":
            ...
            headers["Authorization"] = "Bearer {}".format(get_client().configuration.access_token)
