...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_common_unit_info
except ImportError:
    bt_common_unit_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_common_unit_info"]
...
class BTCommonUnitsInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {"units": ([bt_common_unit_info.BTCommonUnitInfo],)}  # noqa: E501

    @staticmethod
    def discriminator():
        return None

    attribute_map = {"units": "units"}  # noqa: E501
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            units ([bt_common_unit_info.BTCommonUnitInfo]): [optional]  # noqa: E501
        """
