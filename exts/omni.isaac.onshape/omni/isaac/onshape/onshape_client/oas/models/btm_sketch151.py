...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch151_all_of
except ImportError:
    btm_sketch151_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_sketch151_all_of"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_constraint2
except ImportError:
    btm_sketch_constraint2 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_sketch_constraint2"]
try:
...
class BTMSketch151(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btm_feature134.BTMFeature134, btm_sketch151_all_of.BTMSketch151AllOf],
            "oneOf": [],
        }
