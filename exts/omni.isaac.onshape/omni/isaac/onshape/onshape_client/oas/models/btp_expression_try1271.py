...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_try1271_all_of
except ImportError:
    btp_expression_try1271_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_try1271_all_of"
    ]
try:
...
class BTPExpressionTry1271(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_try1271.BTPExpressionTry1271 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_try1271_all_of.BTPExpressionTry1271AllOf],
            "oneOf": [],
        }
