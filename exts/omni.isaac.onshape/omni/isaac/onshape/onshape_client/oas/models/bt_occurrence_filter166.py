...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_occurrence_filter166_all_of
except ImportError:
    bt_occurrence_filter166_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_occurrence_filter166_all_of"
    ]
try:
...
class BTOccurrenceFilter166(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_occurrence_filter166_all_of.BTOccurrenceFilter166AllOf, bt_query_filter183.BTQueryFilter183],
            "oneOf": [],
        }
