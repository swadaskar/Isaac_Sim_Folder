...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_custom_property_definition_params
except ImportError:
    bt_custom_property_definition_params = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_custom_property_definition_params"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_material_params
except ImportError:
    bt_material_params = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_material_params"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_name_value_pair
except ImportError:
    bt_name_value_pair = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_name_value_pair"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_part_appearance_params
except ImportError:
    bt_part_appearance_params = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_part_appearance_params"]
