...
class BTMFeatureQueryWithOccurrence157AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btm_feature_query_with_occurrence157_all_of.BTMFeatureQueryWithOccurrence157AllOf - a model defined in OpenAPI
