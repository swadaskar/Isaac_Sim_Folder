...
try:
    from omni.isaac.onshape.onshape_client.oas.models import subscription_item
except ImportError:
    subscription_item = sys.modules["omni.isaac.onshape.onshape_client.oas.models.subscription_item"]
...
class SubscriptionItemCollection(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            data ([subscription_item.SubscriptionItem]): [optional]  # noqa: E501
