...
try:
    from omni.isaac.onshape.onshape_client.oas.models import encoding
except ImportError:
    encoding = sys.modules["omni.isaac.onshape.onshape_client.oas.models.encoding"]
try:
...
class MediaType(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            encoding ({str: (encoding.Encoding,)}): [optional]  # noqa: E501
