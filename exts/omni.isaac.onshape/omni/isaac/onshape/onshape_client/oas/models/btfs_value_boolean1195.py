...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_boolean1195_all_of
except ImportError:
    btfs_value_boolean1195_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_boolean1195_all_of"
    ]


class BTFSValueBoolean1195(ModelComposed):
    ...
    def __init__(
        ...
        """btfs_value_boolean1195.BTFSValueBoolean1195 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value1888.BTFSValue1888, btfs_value_boolean1195_all_of.BTFSValueBoolean1195AllOf],
            "oneOf": [],
        }
