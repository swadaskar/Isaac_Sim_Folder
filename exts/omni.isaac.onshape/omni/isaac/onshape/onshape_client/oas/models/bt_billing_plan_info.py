...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_discount_info
except ImportError:
    bt_discount_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_discount_info"]


class BTBillingPlanInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_billing_plan_info.BTBillingPlanInfo - a model defined in OpenAPI
