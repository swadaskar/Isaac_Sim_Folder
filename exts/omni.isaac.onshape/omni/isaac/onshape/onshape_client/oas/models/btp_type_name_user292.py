...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_type_name_user292_all_of
except ImportError:
    btp_type_name_user292_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_type_name_user292_all_of"
    ]
...
class BTPTypeNameUser292(ModelComposed):
    ...
    def __init__(
        ...
        """btp_type_name_user292.BTPTypeNameUser292 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_type_name290.BTPTypeName290, btp_type_name_user292_all_of.BTPTypeNameUser292AllOf],
            "oneOf": [],
        }
