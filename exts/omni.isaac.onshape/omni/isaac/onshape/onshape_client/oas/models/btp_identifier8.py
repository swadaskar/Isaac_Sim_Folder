...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_identifier8_all_of
except ImportError:
    btp_identifier8_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_identifier8_all_of"]
try:
...
class BTPIdentifier8(ModelComposed):
    ...
    def __init__(
        ...
        """btp_identifier8.BTPIdentifier8 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_identifier8_all_of.BTPIdentifier8AllOf, btp_property_accessor23.BTPPropertyAccessor23],
            "oneOf": [],
        }
