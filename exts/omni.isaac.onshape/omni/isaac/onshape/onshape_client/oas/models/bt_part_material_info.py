...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_part_material_property_info
except ImportError:
    bt_part_material_property_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_part_material_property_info"
    ]


class BTPartMaterialInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_part_material_info.BTPartMaterialInfo - a model defined in OpenAPI
