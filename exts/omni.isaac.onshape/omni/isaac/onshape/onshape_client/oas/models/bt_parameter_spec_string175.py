...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_string175_all_of
except ImportError:
    bt_parameter_spec_string175_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_string175_all_of"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_string_format_condition683
except ImportError:
    bt_string_format_condition683 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_string_format_condition683"
    ]
try:
...
class BTParameterSpecString175(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_string175.BTParameterSpecString175 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                bt_parameter_spec_string175_all_of.BTParameterSpecString175AllOf,
            ],
            "oneOf": [],
        }
