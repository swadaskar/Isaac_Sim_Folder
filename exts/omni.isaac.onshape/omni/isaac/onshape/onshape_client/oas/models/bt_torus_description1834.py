...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_torus_description1834_all_of
except ImportError:
    bt_torus_description1834_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_torus_description1834_all_of"
    ]
try:
