...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_curve_segment155_all_of
except ImportError:
    btm_sketch_curve_segment155_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_sketch_curve_segment155_all_of"
    ]
