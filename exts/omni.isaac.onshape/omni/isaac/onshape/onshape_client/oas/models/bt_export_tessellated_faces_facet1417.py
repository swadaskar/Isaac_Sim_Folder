...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_vector2d1812
except ImportError:
    bt_vector2d1812 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_vector2d1812"]
try:
...
class BTExportTessellatedFacesFacet1417(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            texture_coordinates ([bt_vector2d1812.BTVector2d1812]): [optional]  # noqa: E501
