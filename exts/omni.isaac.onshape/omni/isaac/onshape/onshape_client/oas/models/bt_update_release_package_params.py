...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_property_value_param
except ImportError:
    bt_property_value_param = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_property_value_param"]
try:
