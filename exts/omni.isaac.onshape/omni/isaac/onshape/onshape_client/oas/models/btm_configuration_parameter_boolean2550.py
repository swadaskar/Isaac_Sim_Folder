...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_configuration_parameter_boolean2550_all_of
except ImportError:
    btm_configuration_parameter_boolean2550_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_configuration_parameter_boolean2550_all_of"
    ]
