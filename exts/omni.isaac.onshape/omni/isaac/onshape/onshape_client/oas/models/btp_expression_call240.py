...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_call240_all_of
except ImportError:
    btp_expression_call240_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_call240_all_of"
    ]
try:
...
class BTPExpressionCall240(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_call240.BTPExpressionCall240 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_call240_all_of.BTPExpressionCall240AllOf],
            "oneOf": [],
        }
