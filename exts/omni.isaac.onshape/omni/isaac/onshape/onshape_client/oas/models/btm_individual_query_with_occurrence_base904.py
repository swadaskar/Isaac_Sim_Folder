...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_feature_query_with_occurrence157
except ImportError:
    btm_feature_query_with_occurrence157 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_feature_query_with_occurrence157"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_individual_occurrence_query626
except ImportError:
    btm_individual_occurrence_query626 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_individual_occurrence_query626"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_individual_query_with_occurrence811
except ImportError:
    btm_individual_query_with_occurrence811 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_individual_query_with_occurrence811"
    ]
...
class BTMIndividualQueryWithOccurrenceBase904(ModelNormal):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTMIndividualQueryWithOccurrence-811": btm_individual_query_with_occurrence811.BTMIndividualQueryWithOccurrence811,
                "BTMIndividualOccurrenceQuery-626": btm_individual_occurrence_query626.BTMIndividualOccurrenceQuery626,
                "BTMFeatureQueryWithOccurrence-157": btm_feature_query_with_occurrence157.BTMFeatureQueryWithOccurrence157,
            }
        }
    ...
    def __init__(
        ...
        """btm_individual_query_with_occurrence_base904.BTMIndividualQueryWithOccurrenceBase904 - a model defined in OpenAPI
