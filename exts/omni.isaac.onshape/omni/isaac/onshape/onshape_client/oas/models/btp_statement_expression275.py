...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_expression275_all_of
except ImportError:
    btp_statement_expression275_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_expression275_all_of"
    ]
