...
try:
    from omni.isaac.onshape.onshape_client.oas.models import customer_card_collection
except ImportError:
    customer_card_collection = sys.modules["omni.isaac.onshape.onshape_client.oas.models.customer_card_collection"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import customer_subscription_collection
except ImportError:
    customer_subscription_collection = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.customer_subscription_collection"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import discount
except ImportError:
    discount = sys.modules["omni.isaac.onshape.onshape_client.oas.models.discount"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import external_account
except ImportError:
    external_account = sys.modules["omni.isaac.onshape.onshape_client.oas.models.external_account"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import external_account_collection
except ImportError:
    external_account_collection = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.external_account_collection"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import next_recurring_charge
except ImportError:
    next_recurring_charge = sys.modules["omni.isaac.onshape.onshape_client.oas.models.next_recurring_charge"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import shipping_details
except ImportError:
    shipping_details = sys.modules["omni.isaac.onshape.onshape_client.oas.models.shipping_details"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import subscription
except ImportError:
    subscription = sys.modules["omni.isaac.onshape.onshape_client.oas.models.subscription"]
