...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_rbac_permission_scheme_info
except ImportError:
    bt_rbac_permission_scheme_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_rbac_permission_scheme_info"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import role_map_entry
except ImportError:
    role_map_entry = sys.modules["omni.isaac.onshape.onshape_client.oas.models.role_map_entry"]
...
class BTProjectInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "permission_scheme": (bt_rbac_permission_scheme_info.BTRbacPermissionSchemeInfo,),  # noqa: E501
