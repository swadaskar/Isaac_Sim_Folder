...
class BTParameterSpecReferenceTable1520(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_reference_table1520.BTParameterSpecReferenceTable1520 - a model defined in OpenAPI
