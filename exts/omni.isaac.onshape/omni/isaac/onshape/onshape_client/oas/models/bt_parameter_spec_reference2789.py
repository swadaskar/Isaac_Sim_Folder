...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec6
except ImportError:
    bt_parameter_spec6 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec6"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_reference_assembly2821
except ImportError:
    bt_parameter_spec_reference_assembly2821 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_reference_assembly2821"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_reference_blob1367
except ImportError:
    bt_parameter_spec_reference_blob1367 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_reference_blob1367"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_reference_part_studio1256
except ImportError:
    bt_parameter_spec_reference_part_studio1256 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_reference_part_studio1256"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_reference_with_configuration2950
except ImportError:
    bt_parameter_spec_reference_with_configuration2950 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_reference_with_configuration2950"
    ]
try:
...
class BTParameterSpecReference2789(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTParameterSpecReferencePartStudio-1256": bt_parameter_spec_reference_part_studio1256.BTParameterSpecReferencePartStudio1256,
                "BTParameterSpecReferenceWithConfiguration-2950": bt_parameter_spec_reference_with_configuration2950.BTParameterSpecReferenceWithConfiguration2950,
                "BTParameterSpecReferenceAssembly-2821": bt_parameter_spec_reference_assembly2821.BTParameterSpecReferenceAssembly2821,
                "BTParameterSpecReferenceBlob-1367": bt_parameter_spec_reference_blob1367.BTParameterSpecReferenceBlob1367,
            }
        }
    ...
    def __init__(
        ...
        """bt_parameter_spec_reference2789.BTParameterSpecReference2789 - a model defined in OpenAPI
