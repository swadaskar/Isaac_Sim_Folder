...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_enum_declaration284_all_of
except ImportError:
    btp_top_level_enum_declaration284_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_enum_declaration284_all_of"
    ]
try:
...
class BTPTopLevelEnumDeclaration284(ModelComposed):
    ...
    def __init__(
        ...
        """btp_top_level_enum_declaration284.BTPTopLevelEnumDeclaration284 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                btp_top_level_enum_declaration284_all_of.BTPTopLevelEnumDeclaration284AllOf,
