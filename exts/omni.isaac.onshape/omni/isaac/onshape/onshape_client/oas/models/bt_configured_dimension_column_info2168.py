...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_configured_dimension_column_info2168_all_of
except ImportError:
    bt_configured_dimension_column_info2168_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_configured_dimension_column_info2168_all_of"
    ]
try:
...
class BTConfiguredDimensionColumnInfo2168(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_configured_dimension_column_info2168_all_of.BTConfiguredDimensionColumnInfo2168AllOf,
