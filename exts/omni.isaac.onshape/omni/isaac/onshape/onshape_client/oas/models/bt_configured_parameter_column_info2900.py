...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_configured_parameter_column_info2900_all_of
except ImportError:
    bt_configured_parameter_column_info2900_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_configured_parameter_column_info2900_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_configured_values_column_info1025
except ImportError:
    bt_configured_values_column_info1025 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_configured_values_column_info1025"
    ]
try:
...
class BTConfiguredParameterColumnInfo2900(ModelComposed):
    ...
    def __init__(
        ...
        """bt_configured_parameter_column_info2900.BTConfiguredParameterColumnInfo2900 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_configured_parameter_column_info2900_all_of.BTConfiguredParameterColumnInfo2900AllOf,
