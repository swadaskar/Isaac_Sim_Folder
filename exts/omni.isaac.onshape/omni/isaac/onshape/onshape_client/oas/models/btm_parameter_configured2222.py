...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_configured_value1341
except ImportError:
    btm_configured_value1341 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_configured_value1341"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_parameter_configured2222_all_of
except ImportError:
    btm_parameter_configured2222_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_parameter_configured2222_all_of"
    ]


class BTMParameterConfigured2222(ModelComposed):
    ...
    def __init__(
        ...
        """btm_parameter_configured2222.BTMParameterConfigured2222 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                btm_parameter_configured2222_all_of.BTMParameterConfigured2222AllOf,
            ],
            "oneOf": [],
        }
