...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_table_spec915
except ImportError:
    bt_table_spec915 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_table_spec915"]
...
class BTFeatureSpec129(ModelNormal):
    ...
    @staticmethod
    def discriminator():
        return {"bt_type": {"BTTableSpec-915": bt_table_spec915.BTTableSpec915}}
