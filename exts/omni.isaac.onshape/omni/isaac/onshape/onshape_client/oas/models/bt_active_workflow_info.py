...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_published_workflow_info
except ImportError:
    bt_published_workflow_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_published_workflow_info"]
