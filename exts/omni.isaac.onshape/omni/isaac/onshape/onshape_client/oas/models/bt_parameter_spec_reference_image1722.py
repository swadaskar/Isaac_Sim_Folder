...
class BTParameterSpecReferenceImage1722(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_reference_image1722.BTParameterSpecReferenceImage1722 - a model defined in OpenAPI
