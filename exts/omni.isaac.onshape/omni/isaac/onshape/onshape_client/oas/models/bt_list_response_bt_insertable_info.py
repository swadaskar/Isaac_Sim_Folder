...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_insertable_info
except ImportError:
    bt_insertable_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_insertable_info"]


class BTListResponseBTInsertableInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_list_response_bt_insertable_info.BTListResponseBTInsertableInfo - a model defined in OpenAPI
