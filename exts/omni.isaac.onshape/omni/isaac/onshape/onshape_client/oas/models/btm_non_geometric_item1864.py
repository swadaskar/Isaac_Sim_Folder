...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_non_geometric_item1864_all_of
except ImportError:
    btm_non_geometric_item1864_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_non_geometric_item1864_all_of"
    ]
try:
...
class BTMNonGeometricItem1864(ModelComposed):
    ...
    def __init__(
        ...
        """btm_non_geometric_item1864.BTMNonGeometricItem1864 - a model defined in OpenAPI
