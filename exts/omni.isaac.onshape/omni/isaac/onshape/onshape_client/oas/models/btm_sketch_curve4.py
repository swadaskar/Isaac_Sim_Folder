...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_curve_geometry114
except ImportError:
    bt_curve_geometry114 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_curve_geometry114"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_curve4_all_of
except ImportError:
    btm_sketch_curve4_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_sketch_curve4_all_of"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_curve_segment155
except ImportError:
    btm_sketch_curve_segment155 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_sketch_curve_segment155"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_geom_entity5
except ImportError:
    btm_sketch_geom_entity5 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_sketch_geom_entity5"]
...
class BTMSketchCurve4(ModelComposed):
    ...
    @staticmethod
    def discriminator():
        return {"bt_type": {"BTMSketchCurveSegment-155": btm_sketch_curve_segment155.BTMSketchCurveSegment155}}
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btm_sketch_curve4_all_of.BTMSketchCurve4AllOf, btm_sketch_geom_entity5.BTMSketchGeomEntity5],
            "oneOf": [],
        }
