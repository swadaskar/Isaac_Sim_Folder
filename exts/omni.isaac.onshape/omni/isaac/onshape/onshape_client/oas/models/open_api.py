...
try:
    from omni.isaac.onshape.onshape_client.oas.models import components
except ImportError:
    components = sys.modules["omni.isaac.onshape.onshape_client.oas.models.components"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import info
except ImportError:
    info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import path_item
except ImportError:
    path_item = sys.modules["omni.isaac.onshape.onshape_client.oas.models.path_item"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import tag
except ImportError:
    tag = sys.modules["omni.isaac.onshape.onshape_client.oas.models.tag"]
