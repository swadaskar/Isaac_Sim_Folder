...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_content_entry_info
except ImportError:
    bt_app_element_content_entry_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_app_element_content_entry_info"
    ]


class BTAppElementContentInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_app_element_content_info.BTAppElementContentInfo - a model defined in OpenAPI
