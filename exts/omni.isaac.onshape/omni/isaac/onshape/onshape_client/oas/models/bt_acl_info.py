...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_acl_entry_info
except ImportError:
    bt_acl_entry_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_acl_entry_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_inherited_acl_info
except ImportError:
    bt_inherited_acl_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_inherited_acl_info"]
try:
...
class BTAclInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "href": (str,),  # noqa: E501
            "id": (str,),  # noqa: E501
            "inherited_acls": ([bt_inherited_acl_info.BTInheritedAclInfo],),  # noqa: E501
            "name": (str,),  # noqa: E501
