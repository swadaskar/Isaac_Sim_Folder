...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_individual_sketch_unique_vertices_query1472_all_of
except ImportError:
    btm_individual_sketch_unique_vertices_query1472_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_individual_sketch_unique_vertices_query1472_all_of"
    ]
try:
