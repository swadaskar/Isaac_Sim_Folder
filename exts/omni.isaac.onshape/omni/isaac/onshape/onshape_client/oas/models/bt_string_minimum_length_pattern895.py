...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_string_minimum_length_pattern895_all_of
except ImportError:
    bt_string_minimum_length_pattern895_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_string_minimum_length_pattern895_all_of"
    ]


class BTStringMinimumLengthPattern895(ModelComposed):
    ...
    def __init__(
        ...
        """bt_string_minimum_length_pattern895.BTStringMinimumLengthPattern895 - a model defined in OpenAPI
