...
try:
    from omni.isaac.onshape.onshape_client.oas.models import contact
except ImportError:
    contact = sys.modules["omni.isaac.onshape.onshape_client.oas.models.contact"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import license
except ImportError:
    license = sys.modules["omni.isaac.onshape.onshape_client.oas.models.license"]
...
class Info(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            contact (contact.Contact): [optional]  # noqa: E501
            description (str): [optional]  # noqa: E501
            extensions ({str: (bool, date, datetime, dict, float, int, list, str,)}): [optional]  # noqa: E501
            license (license.License): [optional]  # noqa: E501
            terms_of_service (str): [optional]  # noqa: E501
