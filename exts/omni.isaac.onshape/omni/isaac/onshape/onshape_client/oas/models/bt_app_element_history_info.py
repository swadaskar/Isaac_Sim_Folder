...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_history_entry_info
except ImportError:
    bt_app_element_history_entry_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_app_element_history_entry_info"
    ]
...
class BTAppElementHistoryInfo(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            changes ([bt_app_element_history_entry_info.BTAppElementHistoryEntryInfo]): [optional]  # noqa: E501
