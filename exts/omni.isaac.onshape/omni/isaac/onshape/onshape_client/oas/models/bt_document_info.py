...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_processing_info
except ImportError:
    bt_document_processing_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_document_processing_info"
    ]
try:
...
class BTDocumentInfo(ModelNormal):
    ...
    @staticmethod
    def discriminator():
        return {"json_type": {"BTDocumentProcessingInfo": bt_document_processing_info.BTDocumentProcessingInfo}}
    ...
    def __init__(
        ...
        """bt_document_info.BTDocumentInfo - a model defined in OpenAPI
