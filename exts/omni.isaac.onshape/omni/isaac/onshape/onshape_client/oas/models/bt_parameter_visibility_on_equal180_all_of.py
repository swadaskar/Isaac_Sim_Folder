...
class BTParameterVisibilityOnEqual180AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_parameter_visibility_on_equal180_all_of.BTParameterVisibilityOnEqual180AllOf - a model defined in OpenAPI
