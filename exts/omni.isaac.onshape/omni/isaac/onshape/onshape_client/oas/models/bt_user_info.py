...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_user_admin_info
except ImportError:
    bt_user_admin_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_user_admin_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_user_info_all_of
except ImportError:
    bt_user_info_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_user_info_all_of"]
try:
...
class BTUserInfo(ModelComposed):
    ...
    @staticmethod
    def discriminator():
        return {"json_type": {"BTUserAdminInfo": bt_user_admin_info.BTUserAdminInfo}}
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_user_info_all_of.BTUserInfoAllOf, bt_user_summary_info.BTUserSummaryInfo],
            "oneOf": [],
        }
