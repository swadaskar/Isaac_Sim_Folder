...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_break272_all_of
except ImportError:
    btp_statement_break272_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_break272_all_of"
    ]


class BTPStatementBreak272(ModelComposed):
    ...
    def __init__(
        ...
        """btp_statement_break272.BTPStatementBreak272 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_statement269.BTPStatement269, btp_statement_break272_all_of.BTPStatementBreak272AllOf],
            "oneOf": [],
        }
