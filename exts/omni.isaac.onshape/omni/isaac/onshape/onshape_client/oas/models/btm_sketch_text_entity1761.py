...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_text_entity1761_all_of
except ImportError:
    btm_sketch_text_entity1761_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_sketch_text_entity1761_all_of"
    ]


class BTMSketchTextEntity1761(ModelComposed):
    ...
    def __init__(
        ...
        """btm_sketch_text_entity1761.BTMSketchTextEntity1761 - a model defined in OpenAPI
