...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_function_declaration246
except ImportError:
    btp_function_declaration246 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_function_declaration246"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_function_or_predicate_declaration247_all_of
except ImportError:
    btp_function_or_predicate_declaration247_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_function_or_predicate_declaration247_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_identifier8
except ImportError:
    btp_identifier8 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_identifier8"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_predicate_declaration265
except ImportError:
    btp_predicate_declaration265 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_predicate_declaration265"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_procedure_declaration_base266
except ImportError:
    btp_procedure_declaration_base266 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_procedure_declaration_base266"
    ]
try:
...
class BTPFunctionOrPredicateDeclaration247(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTPPredicateDeclaration-265": btp_predicate_declaration265.BTPPredicateDeclaration265,
                "BTPFunctionDeclaration-246": btp_function_declaration246.BTPFunctionDeclaration246,
            }
        }
    ...
    def __init__(
        ...
        """btp_function_or_predicate_declaration247.BTPFunctionOrPredicateDeclaration247 - a model defined in OpenAPI
