...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_identity_info
except ImportError:
    bt_identity_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_identity_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_rbac_role_info
except ImportError:
    bt_rbac_role_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_rbac_role_info"]
...
class RoleMapEntry(ModelNormal):
    ...
    attribute_map = {"identities": "identities", "role": "role"}  # noqa: E501  # noqa: E501
