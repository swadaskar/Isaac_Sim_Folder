...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_configuration_parameter_string872_all_of
except ImportError:
    btm_configuration_parameter_string872_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_configuration_parameter_string872_all_of"
    ]


class BTMConfigurationParameterString872(ModelComposed):
    ...
    def __init__(
        ...
        """btm_configuration_parameter_string872.BTMConfigurationParameterString872 - a model defined in OpenAPI
