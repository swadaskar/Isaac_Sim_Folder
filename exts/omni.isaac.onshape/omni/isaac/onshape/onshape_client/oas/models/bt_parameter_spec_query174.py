...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_query174_all_of
except ImportError:
    bt_parameter_spec_query174_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_query174_all_of"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_query_filter183
except ImportError:
    bt_query_filter183 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_query_filter183"]
try:
...
class BTParameterSpecQuery174(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_query174.BTParameterSpecQuery174 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                bt_parameter_spec_query174_all_of.BTParameterSpecQuery174AllOf,
            ],
            "oneOf": [],
        }
