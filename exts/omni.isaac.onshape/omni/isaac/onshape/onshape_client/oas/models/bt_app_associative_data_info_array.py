...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_associative_data_info
except ImportError:
    bt_associative_data_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_associative_data_info"]


class BTAppAssociativeDataInfoArray(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "items": ([bt_associative_data_info.BTAssociativeDataInfo],),  # noqa: E501
    ...
    def __init__(
        ...
        """bt_app_associative_data_info_array.BTAppAssociativeDataInfoArray - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([bt_associative_data_info.BTAssociativeDataInfo]): [optional]  # noqa: E501
