...
class BTMIndividualSketchRegionQuery140AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btm_individual_sketch_region_query140_all_of.BTMIndividualSketchRegionQuery140AllOf - a model defined in OpenAPI
