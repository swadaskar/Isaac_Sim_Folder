...
class BTBaseSMJointTableRowMetadata2232AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_base_sm_joint_table_row_metadata2232_all_of.BTBaseSMJointTableRowMetadata2232AllOf - a model defined in OpenAPI
