...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_import285_all_of
except ImportError:
    btp_top_level_import285_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_import285_all_of"
    ]
try:
...
class BTPTopLevelImport285(ModelComposed):
    ...
    def __init__(
        ...
        """btp_top_level_import285.BTPTopLevelImport285 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                btp_top_level_import285_all_of.BTPTopLevelImport285AllOf,
