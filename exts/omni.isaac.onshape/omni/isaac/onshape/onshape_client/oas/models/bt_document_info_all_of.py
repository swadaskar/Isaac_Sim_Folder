...
from omni.isaac.onshape.onshape_client.oas.model_utils import ModelNormal, date, datetime, int, str  # noqa: F401
...
class BTDocumentInfoAllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_document_info_all_of.BTDocumentInfoAllOf - a model defined in OpenAPI
