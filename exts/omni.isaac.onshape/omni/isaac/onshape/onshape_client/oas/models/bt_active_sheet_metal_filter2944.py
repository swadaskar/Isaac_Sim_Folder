...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_active_sheet_metal_filter2944_all_of
except ImportError:
    bt_active_sheet_metal_filter2944_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_active_sheet_metal_filter2944_all_of"
    ]
try:
...
class BTActiveSheetMetalFilter2944(ModelComposed):
    ...
    def openapi_types():
        ...
        """
        return {"bt_type": (str,), "is_from_active_sheet_metal": (bool,)}  # noqa: E501  # noqa: E501
