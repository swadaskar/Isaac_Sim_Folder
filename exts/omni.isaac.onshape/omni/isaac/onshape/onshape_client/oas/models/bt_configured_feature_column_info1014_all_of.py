...
class BTConfiguredFeatureColumnInfo1014AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_configured_feature_column_info1014_all_of.BTConfiguredFeatureColumnInfo1014AllOf - a model defined in OpenAPI
