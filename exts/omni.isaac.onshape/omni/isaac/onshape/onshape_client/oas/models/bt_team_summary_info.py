...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_team_info
except ImportError:
    bt_team_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_team_info"]
try:
...
class BTTeamSummaryInfo(ModelNormal):
    ...
    @staticmethod
    def discriminator():
        return {"json_type": {"BTTeamInfo": bt_team_info.BTTeamInfo}}
    ...
    def __init__(
        ...
        """bt_team_summary_info.BTTeamSummaryInfo - a model defined in OpenAPI
