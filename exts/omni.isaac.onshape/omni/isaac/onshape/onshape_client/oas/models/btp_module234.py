...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_cache_data_path191
except ImportError:
    bt_cache_data_path191 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_cache_data_path191"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_import
except ImportError:
    bt_import = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_import"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_microversion_id366
except ImportError:
    bt_microversion_id366 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_microversion_id366"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_module234_all_of
except ImportError:
    btp_module234_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_module234_all_of"]
try:
...
class BTPModule234(ModelComposed):
    ...
    def __init__(
        ...
        """btp_module234.BTPModule234 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        # loading
        return {"anyOf": [], "allOf": [btp_module234_all_of.BTPModule234AllOf, btp_node7.BTPNode7], "oneOf": []}
