...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_cloud_storage_account_info
except ImportError:
    bt_cloud_storage_account_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_cloud_storage_account_info"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_folder_info
except ImportError:
    bt_folder_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_folder_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_global_tree_magic_node_info
except ImportError:
    bt_global_tree_magic_node_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_global_tree_magic_node_info"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_project_info
except ImportError:
    bt_project_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_project_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_team_summary_info
except ImportError:
    bt_team_summary_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_team_summary_info"]
try:
