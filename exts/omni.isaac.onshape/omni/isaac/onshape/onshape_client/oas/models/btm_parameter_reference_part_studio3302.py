...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_parameter_reference_part_studio3302_all_of
except ImportError:
    btm_parameter_reference_part_studio3302_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_parameter_reference_part_studio3302_all_of"
    ]
try:
...
class BTMParameterReferencePartStudio3302(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                btm_parameter_reference_part_studio3302_all_of.BTMParameterReferencePartStudio3302AllOf,
                btm_parameter_reference_with_configuration3028.BTMParameterReferenceWithConfiguration3028,
            ],
            "oneOf": [],
        }
