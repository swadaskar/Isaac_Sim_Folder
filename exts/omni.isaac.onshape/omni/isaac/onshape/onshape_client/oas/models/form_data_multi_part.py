...
try:
    from omni.isaac.onshape.onshape_client.oas.models import body_part
except ImportError:
    body_part = sys.modules["omni.isaac.onshape.onshape_client.oas.models.body_part"]
try:
...
try:
    ...
    form_data_body_part = sys.modules["omni.isaac.onshape.onshape_client.oas.models.form_data_body_part"]
try:
