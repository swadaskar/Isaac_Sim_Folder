...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_string259_all_of
except ImportError:
    btp_literal_string259_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_literal_string259_all_of"
    ]
try:
...
class BTPLiteralString259(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_literal253.BTPLiteral253, btp_literal_string259_all_of.BTPLiteralString259AllOf],
            "oneOf": [],
        }
