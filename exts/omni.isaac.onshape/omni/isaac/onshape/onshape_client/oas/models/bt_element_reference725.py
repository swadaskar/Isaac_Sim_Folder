...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_external_reference1936
except ImportError:
    bt_external_reference1936 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_external_reference1936"]
try:
...
class BTElementReference725(ModelNormal):
    ...
    @staticmethod
    def discriminator():
        return {"bt_type": {"BTExternalReference-1936": bt_external_reference1936.BTExternalReference1936}}
