...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btpl_value_access250
except ImportError:
    btpl_value_access250 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btpl_value_access250"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btpl_value_box_dereference251
except ImportError:
    btpl_value_box_dereference251 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btpl_value_box_dereference251"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btpl_value_var_reference252
except ImportError:
    btpl_value_var_reference252 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btpl_value_var_reference252"
    ]
...
class BTPLValue249(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTPLValueVarReference-252": btpl_value_var_reference252.BTPLValueVarReference252,
                "BTPLValueAccess-250": btpl_value_access250.BTPLValueAccess250,
                "BTPLValueBoxDereference-251": btpl_value_box_dereference251.BTPLValueBoxDereference251,
            }
        }
    ...
    def __init__(
        ...
        """btpl_value249.BTPLValue249 - a model defined in OpenAPI
