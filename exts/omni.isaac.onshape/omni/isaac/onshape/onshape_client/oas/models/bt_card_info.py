...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_address_info
except ImportError:
    bt_address_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_address_info"]
...
class BTCardInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_card_info.BTCardInfo - a model defined in OpenAPI
