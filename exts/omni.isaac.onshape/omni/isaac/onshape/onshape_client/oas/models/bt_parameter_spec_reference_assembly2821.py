...
class BTParameterSpecReferenceAssembly2821(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_reference_assembly2821.BTParameterSpecReferenceAssembly2821 - a model defined in OpenAPI
