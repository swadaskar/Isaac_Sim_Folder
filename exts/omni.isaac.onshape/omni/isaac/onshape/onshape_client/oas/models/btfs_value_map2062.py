...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_map_entry2077
except ImportError:
    btfs_value_map_entry2077 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btfs_value_map_entry2077"]
...
class BTFSValueMap2062(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            fsvalues_keyed_by_strings ({str: (btfs_value1888.BTFSValue1888,)}): [optional]  # noqa: E501
            standard_type_name (str): [optional]  # noqa: E501
            type_tag (str): [optional]  # noqa: E501
            value ([btfs_value_map_entry2077.BTFSValueMapEntry2077]): [optional]  # noqa: E501
            value_object ({str: (bool, date, datetime, dict, float, int, list, str,)}): [optional]  # noqa: E501
        """
