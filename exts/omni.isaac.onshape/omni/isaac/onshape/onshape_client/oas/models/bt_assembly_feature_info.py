...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_assembly_feature_data_info
except ImportError:
    bt_assembly_feature_data_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_assembly_feature_data_info"
    ]


class BTAssemblyFeatureInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_assembly_feature_info.BTAssemblyFeatureInfo - a model defined in OpenAPI
