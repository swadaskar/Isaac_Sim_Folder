...
class BTConfiguredDimensionColumnInfo2168AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_configured_dimension_column_info2168_all_of.BTConfiguredDimensionColumnInfo2168AllOf - a model defined in OpenAPI
