...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_folder_info_all_of
except ImportError:
    bt_folder_info_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_folder_info_all_of"]
try:
...
class BTFolderInfo(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_folder_info_all_of.BTFolderInfoAllOf, bt_global_tree_node_info.BTGlobalTreeNodeInfo],
            "oneOf": [],
        }
