...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_base_info
except ImportError:
    bt_base_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_base_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_info
except ImportError:
    bt_document_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_document_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_label_info
except ImportError:
    bt_document_label_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_document_label_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_summary_info_all_of
except ImportError:
    bt_document_summary_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_document_summary_info_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_summary_search_info
except ImportError:
    bt_document_summary_search_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_document_summary_search_info"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_global_tree_node_info
except ImportError:
    bt_global_tree_node_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_global_tree_node_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_owner_info
except ImportError:
    bt_owner_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_owner_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_thumbnail_info
except ImportError:
    bt_thumbnail_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_thumbnail_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_user_basic_summary_info
except ImportError:
    bt_user_basic_summary_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_user_basic_summary_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_workspace_info
except ImportError:
    bt_workspace_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_workspace_info"]
...
class BTDocumentSummaryInfo(ModelComposed):
    ...
    def discriminator():
        return {
            "json_type": {"BTDocumentSummarySearchInfo": bt_document_summary_search_info.BTDocumentSummarySearchInfo}
        }
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_document_summary_info_all_of.BTDocumentSummaryInfoAllOf,
