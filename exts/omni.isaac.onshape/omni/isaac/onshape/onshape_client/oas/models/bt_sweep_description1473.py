...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_sweep_description1473_all_of
except ImportError:
    bt_sweep_description1473_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_sweep_description1473_all_of"
    ]
try:
