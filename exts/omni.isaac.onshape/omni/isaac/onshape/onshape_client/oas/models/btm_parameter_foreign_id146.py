...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_foreign_data_response1070
except ImportError:
    bt_foreign_data_response1070 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_foreign_data_response1070"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_parameter_foreign_id146_all_of
except ImportError:
    btm_parameter_foreign_id146_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_parameter_foreign_id146_all_of"
    ]
...
class BTMParameterForeignId146(ModelComposed):
    ...
    def __init__(
        ...
        """btm_parameter_foreign_id146.BTMParameterForeignId146 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btm_parameter1.BTMParameter1, btm_parameter_foreign_id146_all_of.BTMParameterForeignId146AllOf],
            "oneOf": [],
        }
