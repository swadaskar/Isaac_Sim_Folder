...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_share_entry_params
except ImportError:
    bt_share_entry_params = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_share_entry_params"]
...
class BTShareParams(ModelNormal):
    ...
    def __init__(
        ...
        """bt_share_params.BTShareParams - a model defined in OpenAPI
