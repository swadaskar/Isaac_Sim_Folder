...
try:
    from omni.isaac.onshape.onshape_client.oas.models import entry
except ImportError:
    entry = sys.modules["omni.isaac.onshape.onshape_client.oas.models.entry"]


class BTRbacPermissionSchemeInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_rbac_permission_scheme_info.BTRbacPermissionSchemeInfo - a model defined in OpenAPI
