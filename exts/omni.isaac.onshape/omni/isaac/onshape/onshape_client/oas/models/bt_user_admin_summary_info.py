...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_user_admin_summary_info_all_of
except ImportError:
    bt_user_admin_summary_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_user_admin_summary_info_all_of"
    ]
try:
