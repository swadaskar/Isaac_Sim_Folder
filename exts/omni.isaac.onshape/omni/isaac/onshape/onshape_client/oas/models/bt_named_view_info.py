...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_section_plane_info
except ImportError:
    bt_section_plane_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_section_plane_info"]


class BTNamedViewInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_named_view_info.BTNamedViewInfo - a model defined in OpenAPI
