...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_as238_all_of
except ImportError:
    btp_expression_as238_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_as238_all_of"
    ]
try:
...
class BTPExpressionAs238(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_as238.BTPExpressionAs238 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_as238_all_of.BTPExpressionAs238AllOf],
            "oneOf": [],
        }
