...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_team_info_all_of
except ImportError:
    bt_team_info_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_team_info_all_of"]
try:
...
class BTTeamInfo(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_team_info_all_of.BTTeamInfoAllOf, bt_team_summary_info.BTTeamSummaryInfo],
            "oneOf": [],
        }
