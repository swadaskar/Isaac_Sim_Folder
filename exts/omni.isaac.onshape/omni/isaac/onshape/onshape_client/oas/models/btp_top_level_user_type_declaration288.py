...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_type_declaration287
except ImportError:
    btp_top_level_type_declaration287 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_type_declaration287"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_user_type_declaration288_all_of
except ImportError:
    btp_top_level_user_type_declaration288_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_user_type_declaration288_all_of"
    ]


class BTPTopLevelUserTypeDeclaration288(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "typecheck": (btp_name261.BTPName261,),  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                btp_top_level_type_declaration287.BTPTopLevelTypeDeclaration287,
                btp_top_level_user_type_declaration288_all_of.BTPTopLevelUserTypeDeclaration288AllOf,
            ],
            "oneOf": [],
        }
