...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_switch2632_all_of
except ImportError:
    btp_expression_switch2632_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_switch2632_all_of"
    ]
try:
...
class BTPExpressionSwitch2632(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_switch2632.BTPExpressionSwitch2632 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_switch2632_all_of.BTPExpressionSwitch2632AllOf],
            "oneOf": [],
        }
