...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_set_feature_rollback_call1899_all_of
except ImportError:
    bt_set_feature_rollback_call1899_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_set_feature_rollback_call1899_all_of"
    ]


class BTSetFeatureRollbackCall1899(ModelComposed):
    ...
    def __init__(
        ...
        """bt_set_feature_rollback_call1899.BTSetFeatureRollbackCall1899 - a model defined in OpenAPI
