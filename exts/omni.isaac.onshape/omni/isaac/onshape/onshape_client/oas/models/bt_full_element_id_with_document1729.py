...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_full_element_id_and_part_id643
except ImportError:
    bt_full_element_id_and_part_id643 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_full_element_id_and_part_id643"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_full_element_id_with_document1729_all_of
except ImportError:
    bt_full_element_id_with_document1729_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_full_element_id_with_document1729_all_of"
    ]
try:
...
class BTFullElementIdWithDocument1729(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {"BTFullElementIdAndPartId-643": bt_full_element_id_and_part_id643.BTFullElementIdAndPartId643}
        }
