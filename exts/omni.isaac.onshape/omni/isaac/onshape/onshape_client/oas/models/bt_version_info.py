...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_version_info_all_of
except ImportError:
    bt_version_info_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_version_info_all_of"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_version_info_base
except ImportError:
    bt_version_info_base = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_version_info_base"]
...
class BTVersionInfo(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_version_info_all_of.BTVersionInfoAllOf, bt_version_info_base.BTVersionInfoBase],
            "oneOf": [],
        }
