...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_color_info
except ImportError:
    bt_color_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_color_info"]
