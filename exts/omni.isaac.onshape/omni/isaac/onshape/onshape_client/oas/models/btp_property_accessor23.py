...
class BTPPropertyAccessor23(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTPIdentifier-8": btp_identifier8.BTPIdentifier8,
                "BTPExpression-9": btp_expression9.BTPExpression9,
            }
        }
    ...
    def __init__(
        ...
        """btp_property_accessor23.BTPPropertyAccessor23 - a model defined in OpenAPI
