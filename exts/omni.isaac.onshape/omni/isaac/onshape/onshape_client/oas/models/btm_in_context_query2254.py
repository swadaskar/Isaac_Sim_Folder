...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_in_context_query2254_all_of
except ImportError:
    btm_in_context_query2254_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_in_context_query2254_all_of"
    ]
try:
...
class BTMInContextQuery2254(ModelComposed):
    ...
    def __init__(
        ...
        """btm_in_context_query2254.BTMInContextQuery2254 - a model defined in OpenAPI
