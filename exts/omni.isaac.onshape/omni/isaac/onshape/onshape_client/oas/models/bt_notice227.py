...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_node_reference21
except ImportError:
    bt_node_reference21 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_node_reference21"]
