...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_module_id235_all_of
except ImportError:
    btp_module_id235_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_module_id235_all_of"]
try:
...
class BTPModuleId235(ModelComposed):
    ...
    def _composed_schemas():
        ...
        # loading
        return {"anyOf": [], "allOf": [btp_module_id235_all_of.BTPModuleId235AllOf, btp_node7.BTPNode7], "oneOf": []}
