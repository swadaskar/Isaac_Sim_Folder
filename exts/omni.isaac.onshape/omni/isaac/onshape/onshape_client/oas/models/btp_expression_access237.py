...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_access237_all_of
except ImportError:
    btp_expression_access237_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_access237_all_of"
    ]
try:
...
class BTPExpressionAccess237(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_access237_all_of.BTPExpressionAccess237AllOf],
            "oneOf": [],
        }
