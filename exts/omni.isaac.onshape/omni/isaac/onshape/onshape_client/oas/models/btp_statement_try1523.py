...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_try1523_all_of
except ImportError:
    btp_statement_try1523_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_try1523_all_of"
    ]


class BTPStatementTry1523(ModelComposed):
    ...
    def __init__(
        ...
        """btp_statement_try1523.BTPStatementTry1523 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_statement269.BTPStatement269, btp_statement_try1523_all_of.BTPStatementTry1523AllOf],
            "oneOf": [],
        }
