...
try:
    ...
    bt_version_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_version_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_version_info_base_all_of
except ImportError:
    bt_version_info_base_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_version_info_base_all_of"
    ]
try:
...
class BTVersionInfoBase(ModelComposed):
    ...
    @staticmethod
    def discriminator():
        return {"type": {"BTVersionInfo": bt_version_info.BTVersionInfo}}
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_base_info.BTBaseInfo, bt_version_info_base_all_of.BTVersionInfoBaseAllOf],
            "oneOf": [],
        }
