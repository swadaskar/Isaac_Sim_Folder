...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_name261_all_of
except ImportError:
    btp_name261_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_name261_all_of"]
try:
...
class BTPName261(ModelComposed):
    ...
    def __init__(
        ...
        """btp_name261.BTPName261 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        # loading
        return {"anyOf": [], "allOf": [btp_name261_all_of.BTPName261AllOf, btp_node7.BTPNode7], "oneOf": []}
