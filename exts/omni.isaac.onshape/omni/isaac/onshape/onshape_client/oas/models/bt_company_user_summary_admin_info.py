...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_company_user_summary_admin_info_all_of
except ImportError:
    bt_company_user_summary_admin_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_company_user_summary_admin_info_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_company_user_summary_info
except ImportError:
    bt_company_user_summary_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_company_user_summary_info"
    ]
try:
...
class BTCompanyUserSummaryAdminInfo(ModelComposed):
    ...
    def __init__(
        ...
        """bt_company_user_summary_admin_info.BTCompanyUserSummaryAdminInfo - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_company_user_summary_admin_info_all_of.BTCompanyUserSummaryAdminInfoAllOf,
                bt_company_user_summary_info.BTCompanyUserSummaryInfo,
            ],
            "oneOf": [],
        }
