...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_webhook_options
except ImportError:
    bt_webhook_options = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_webhook_options"]


class BTWebhookParams(ModelNormal):
    ...
    def __init__(
        ...
        """bt_webhook_params.BTWebhookParams - a model defined in OpenAPI
