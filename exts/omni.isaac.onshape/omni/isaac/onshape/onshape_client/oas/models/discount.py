...
try:
    from omni.isaac.onshape.onshape_client.oas.models import coupon
except ImportError:
    coupon = sys.modules["omni.isaac.onshape.onshape_client.oas.models.coupon"]
...
class Discount(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            "coupon": (coupon.Coupon,),  # noqa: E501
    ...
    def __init__(
        ...
        """discount.Discount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            coupon (coupon.Coupon): [optional]  # noqa: E501
