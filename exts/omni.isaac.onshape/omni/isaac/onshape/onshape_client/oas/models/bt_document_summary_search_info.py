...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_search_hit_info
except ImportError:
    bt_document_search_hit_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_document_search_hit_info"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_summary_info
except ImportError:
    bt_document_summary_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_document_summary_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_document_summary_search_info_all_of
except ImportError:
    bt_document_summary_search_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_document_summary_search_info_all_of"
    ]
try:
...
class BTDocumentSummarySearchInfo(ModelComposed):
    ...
    def openapi_types():
        ...
        """
        return {
            "search_hits": ([bt_document_search_hit_info.BTDocumentSearchHitInfo],),  # noqa: E501
