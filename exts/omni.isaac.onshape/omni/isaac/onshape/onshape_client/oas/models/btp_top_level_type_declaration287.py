...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_number258
except ImportError:
    btp_literal_number258 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_number258"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_enum_declaration284
except ImportError:
    btp_top_level_enum_declaration284 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_enum_declaration284"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_type_declaration287_all_of
except ImportError:
    btp_top_level_type_declaration287_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_type_declaration287_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_user_type_declaration288
except ImportError:
    btp_top_level_user_type_declaration288 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_user_type_declaration288"
    ]


class BTPTopLevelTypeDeclaration287(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTPTopLevelEnumDeclaration-284": btp_top_level_enum_declaration284.BTPTopLevelEnumDeclaration284,
                "BTPTopLevelUserTypeDeclaration-288": btp_top_level_user_type_declaration288.BTPTopLevelUserTypeDeclaration288,
            }
        }
    ...
    def __init__(
        ...
        """btp_top_level_type_declaration287.BTPTopLevelTypeDeclaration287 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                btp_top_level_type_declaration287_all_of.BTPTopLevelTypeDeclaration287AllOf,
            ],
            "oneOf": [],
        }
