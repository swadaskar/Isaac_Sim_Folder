...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_tree_node20
except ImportError:
    bt_tree_node20 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_tree_node20"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_configuration_parameter819
except ImportError:
    btm_configuration_parameter819 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_configuration_parameter819"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_configuration_parameter_quantity1826_all_of
except ImportError:
    btm_configuration_parameter_quantity1826_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_configuration_parameter_quantity1826_all_of"
    ]


class BTMConfigurationParameterQuantity1826(ModelComposed):
    ...
    allowed_values = {
        ...
        ("parameter_type",): {"ENUM": "ENUM", "BOOLEAN": "BOOLEAN", "STRING": "STRING", "QUANTITY": "QUANTITY"},
    }
    ...
    def __init__(
        ...
        """btm_configuration_parameter_quantity1826.BTMConfigurationParameterQuantity1826 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                btm_configuration_parameter_quantity1826_all_of.BTMConfigurationParameterQuantity1826AllOf,
            ],
            "oneOf": [],
        }
