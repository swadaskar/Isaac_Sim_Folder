...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_operator244_all_of
except ImportError:
    btp_expression_operator244_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_operator244_all_of"
    ]
try:
...
class BTPExpressionOperator244(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_operator244_all_of.BTPExpressionOperator244AllOf],
            "oneOf": [],
        }
