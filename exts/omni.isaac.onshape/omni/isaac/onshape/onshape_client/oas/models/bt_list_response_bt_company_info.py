...
try:
    ...
    bt_company_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_company_info"]
...
class BTListResponseBTCompanyInfo(ModelNormal):
    ...
    def __init__(
        ...
        """bt_list_response_bt_company_info.BTListResponseBTCompanyInfo - a model defined in OpenAPI
