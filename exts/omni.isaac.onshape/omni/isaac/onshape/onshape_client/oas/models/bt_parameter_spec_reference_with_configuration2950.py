...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_reference_with_configuration2950_all_of
except ImportError:
    bt_parameter_spec_reference_with_configuration2950_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_reference_with_configuration2950_all_of"
    ]
try:
...
class BTParameterSpecReferenceWithConfiguration2950(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_reference_with_configuration2950.BTParameterSpecReferenceWithConfiguration2950 - a model defined in OpenAPI
