...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_function1325_all_of
except ImportError:
    btp_expression_function1325_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_function1325_all_of"
    ]
try:
...
class BTPExpressionFunction1325(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_function1325.BTPExpressionFunction1325 - a model defined in OpenAPI
