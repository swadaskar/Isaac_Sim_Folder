...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_curve_geometry_spline118_all_of
except ImportError:
    bt_curve_geometry_spline118_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_curve_geometry_spline118_all_of"
    ]
