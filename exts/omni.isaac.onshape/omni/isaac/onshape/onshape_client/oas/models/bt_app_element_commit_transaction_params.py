...
class BTAppElementCommitTransactionParams(ModelNormal):
    ...
    def __init__(
        ...
        """bt_app_element_commit_transaction_params.BTAppElementCommitTransactionParams - a model defined in OpenAPI
