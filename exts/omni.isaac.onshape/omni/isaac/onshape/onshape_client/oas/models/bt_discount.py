...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_discount_owner_id_plan_id
except ImportError:
    bt_discount_owner_id_plan_id = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_discount_owner_id_plan_id"
    ]
