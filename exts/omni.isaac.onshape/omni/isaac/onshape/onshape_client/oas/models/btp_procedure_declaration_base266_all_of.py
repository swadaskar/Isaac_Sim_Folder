...
class BTPProcedureDeclarationBase266AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btp_procedure_declaration_base266_all_of.BTPProcedureDeclarationBase266AllOf - a model defined in OpenAPI
