...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_comment_attachment_info
except ImportError:
    bt_comment_attachment_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_comment_attachment_info"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_view_data_info
except ImportError:
    bt_view_data_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_view_data_info"]
...
class BTCommentInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "attachment": (bt_comment_attachment_info.BTCommentAttachmentInfo,),  # noqa: E501
