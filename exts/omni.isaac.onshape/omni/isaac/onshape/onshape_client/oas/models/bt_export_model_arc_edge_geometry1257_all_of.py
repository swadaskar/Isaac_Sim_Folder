...
class BTExportModelArcEdgeGeometry1257AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_export_model_arc_edge_geometry1257_all_of.BTExportModelArcEdgeGeometry1257AllOf - a model defined in OpenAPI
