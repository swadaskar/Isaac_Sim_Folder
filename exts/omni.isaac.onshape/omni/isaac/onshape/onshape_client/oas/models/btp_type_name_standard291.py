...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_other1124_all_of
except ImportError:
    btfs_value_other1124_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_other1124_all_of"
    ]
try:
...
class BTPTypeNameStandard291(ModelComposed):
    ...
    def __init__(
        ...
        """btp_type_name_standard291.BTPTypeNameStandard291 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value_other1124_all_of.BTFSValueOther1124AllOf, btp_type_name290.BTPTypeName290],
            "oneOf": [],
        }
