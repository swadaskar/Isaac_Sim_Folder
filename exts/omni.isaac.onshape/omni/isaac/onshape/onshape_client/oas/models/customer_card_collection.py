...
try:
    from omni.isaac.onshape.onshape_client.oas.models import card
except ImportError:
    card = sys.modules["omni.isaac.onshape.onshape_client.oas.models.card"]
try:
...
class CustomerCardCollection(ModelNormal):
    ...
    def __init__(
        ...
        """customer_card_collection.CustomerCardCollection - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ([card.Card]): [optional]  # noqa: E501
