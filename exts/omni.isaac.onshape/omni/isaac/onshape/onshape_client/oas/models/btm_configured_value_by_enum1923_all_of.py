...
class BTMConfiguredValueByEnum1923AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btm_configured_value_by_enum1923_all_of.BTMConfiguredValueByEnum1923AllOf - a model defined in OpenAPI
