...
class BTMIndividualCreatedByQuery137AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btm_individual_created_by_query137_all_of.BTMIndividualCreatedByQuery137AllOf - a model defined in OpenAPI
