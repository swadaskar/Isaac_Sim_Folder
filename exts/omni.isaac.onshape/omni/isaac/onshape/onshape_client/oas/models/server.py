...
try:
    from omni.isaac.onshape.onshape_client.oas.models import server_variable
except ImportError:
    server_variable = sys.modules["omni.isaac.onshape.onshape_client.oas.models.server_variable"]
...
class Server(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            variables ({str: (server_variable.ServerVariable,)}): [optional]  # noqa: E501
        """
