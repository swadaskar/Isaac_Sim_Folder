...
from omni.isaac.onshape.onshape_client.oas.model_utils import ModelNormal, datetime, str  # noqa: F401


class BTUserAdminSummaryInfoAllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_user_admin_summary_info_all_of.BTUserAdminSummaryInfoAllOf - a model defined in OpenAPI
