...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_block271_all_of
except ImportError:
    btp_statement_block271_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_block271_all_of"
    ]
...
class BTPStatementBlock271(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_statement269.BTPStatement269, btp_statement_block271_all_of.BTPStatementBlock271AllOf],
            "oneOf": [],
        }
