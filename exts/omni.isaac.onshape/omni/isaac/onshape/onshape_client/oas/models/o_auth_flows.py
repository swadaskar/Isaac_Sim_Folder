...
try:
    from omni.isaac.onshape.onshape_client.oas.models import o_auth_flow
except ImportError:
    o_auth_flow = sys.modules["omni.isaac.onshape.onshape_client.oas.models.o_auth_flow"]
...
class OAuthFlows(ModelNormal):
    ...
    def __init__(
        ...
        Keyword Args:
            ...
            authorization_code (o_auth_flow.OAuthFlow): [optional]  # noqa: E501
            client_credentials (o_auth_flow.OAuthFlow): [optional]  # noqa: E501
            extensions ({str: (bool, date, datetime, dict, float, int, list, str,)}): [optional]  # noqa: E501
            implicit (o_auth_flow.OAuthFlow): [optional]  # noqa: E501
            password (o_auth_flow.OAuthFlow): [optional]  # noqa: E501
        """
