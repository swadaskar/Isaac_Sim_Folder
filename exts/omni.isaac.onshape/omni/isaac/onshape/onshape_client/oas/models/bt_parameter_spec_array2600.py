...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_array2600_all_of
except ImportError:
    bt_parameter_spec_array2600_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_array2600_all_of"
    ]
try:
