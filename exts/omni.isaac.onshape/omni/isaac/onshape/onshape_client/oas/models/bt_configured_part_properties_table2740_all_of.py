...
class BTConfiguredPartPropertiesTable2740AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_configured_part_properties_table2740_all_of.BTConfiguredPartPropertiesTable2740AllOf - a model defined in OpenAPI
