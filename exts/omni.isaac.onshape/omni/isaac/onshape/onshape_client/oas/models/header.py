...
class Header(ModelNormal):
    ...
    allowed_values = {("style",): {"SIMPLE": "SIMPLE"}}
    ...
    def __init__(
        ...
        """header.Header - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            style (str): [optional] if omitted the server will use the default value of 'SIMPLE'  # noqa: E501
        """
