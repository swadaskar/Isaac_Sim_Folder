...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_release_package_item_params
except ImportError:
    bt_release_package_item_params = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_release_package_item_params"
    ]
...
class BTReleasePackageParams(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {"items": ([bt_release_package_item_params.BTReleasePackageItemParams],)}  # noqa: E501

    @staticmethod
    def discriminator():
        return None

    attribute_map = {"items": "items"}  # noqa: E501
    ...
    def __init__(
        ...
        """bt_release_package_params.BTReleasePackageParams - a model defined in OpenAPI
