...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_string_format_block_pattern1755_all_of
except ImportError:
    bt_string_format_block_pattern1755_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_string_format_block_pattern1755_all_of"
    ]
try:
