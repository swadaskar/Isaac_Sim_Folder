...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_sketch_point158_all_of
except ImportError:
    btm_sketch_point158_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btm_sketch_point158_all_of"]


class BTMSketchPoint158(ModelComposed):
    ...
    def __init__(
        ...
        """btm_sketch_point158.BTMSketchPoint158 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btm_sketch_geom_entity5.BTMSketchGeomEntity5, btm_sketch_point158_all_of.BTMSketchPoint158AllOf],
            "oneOf": [],
        }
