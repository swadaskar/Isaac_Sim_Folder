...
class BTActiveSheetMetalFilter2944AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_active_sheet_metal_filter2944_all_of.BTActiveSheetMetalFilter2944AllOf - a model defined in OpenAPI
