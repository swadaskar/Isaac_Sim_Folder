...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_comment_info
except ImportError:
    bt_comment_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_comment_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_published_workflow_id
except ImportError:
    bt_published_workflow_id = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_published_workflow_id"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_release_comment_list_info
except ImportError:
    bt_release_comment_list_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_release_comment_list_info"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_release_package_item_info
except ImportError:
    bt_release_package_item_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_release_package_item_info"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_workflow_property_info
except ImportError:
    bt_workflow_property_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_workflow_property_info"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_workflow_snapshot_info
except ImportError:
    bt_workflow_snapshot_info = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_workflow_snapshot_info"]
