...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_visibility_logical178_all_of
except ImportError:
    bt_parameter_visibility_logical178_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_visibility_logical178_all_of"
    ]
...
class BTParameterVisibilityLogical178(ModelComposed):
    ...
    allowed_values = {("operation",): {"NOT": "NOT", "AND": "AND", "OR": "OR", "UNKNOWN": "UNKNOWN"}}
