...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_loop_while280_all_of
except ImportError:
    btp_statement_loop_while280_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_loop_while280_all_of"
    ]
