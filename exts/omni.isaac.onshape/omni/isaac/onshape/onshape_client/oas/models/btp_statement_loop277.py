...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_loop277_all_of
except ImportError:
    btp_statement_loop277_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_loop277_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_loop_for3278
except ImportError:
    btp_statement_loop_for3278 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_statement_loop_for3278"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_loop_for_in279
except ImportError:
    btp_statement_loop_for_in279 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_loop_for_in279"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_loop_while280
except ImportError:
    btp_statement_loop_while280 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_statement_loop_while280"
    ]
...
class BTPStatementLoop277(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_statement269.BTPStatement269, btp_statement_loop277_all_of.BTPStatementLoop277AllOf],
            "oneOf": [],
        }
