...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression9
except ImportError:
    btp_expression9 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_expression9"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_array254
except ImportError:
    btp_literal_array254 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_array254"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_boolean255
except ImportError:
    btp_literal_boolean255 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_boolean255"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_map256
except ImportError:
    btp_literal_map256 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_map256"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_string259
except ImportError:
    btp_literal_string259 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_string259"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_undefined260
except ImportError:
    btp_literal_undefined260 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_literal_undefined260"]
try:
...
class BTPLiteral253(ModelComposed):
    ...
    def __init__(
        ...
        """btp_literal253.BTPLiteral253 - a model defined in OpenAPI
