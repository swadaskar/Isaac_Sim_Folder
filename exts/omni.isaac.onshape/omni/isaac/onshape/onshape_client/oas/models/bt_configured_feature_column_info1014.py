...
class BTConfiguredFeatureColumnInfo1014(ModelComposed):
    ...
    def __init__(
        ...
        """bt_configured_feature_column_info1014.BTConfiguredFeatureColumnInfo1014 - a model defined in OpenAPI
