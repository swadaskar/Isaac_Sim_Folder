...
try:
    from omni.isaac.onshape.onshape_client.oas.models import body_part_media_type
except ImportError:
    body_part_media_type = sys.modules["omni.isaac.onshape.onshape_client.oas.models.body_part_media_type"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import content_disposition
except ImportError:
    content_disposition = sys.modules["omni.isaac.onshape.onshape_client.oas.models.content_disposition"]
try:
    ...
    form_data_content_disposition = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.form_data_content_disposition"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import multi_part
except ImportError:
    multi_part = sys.modules["omni.isaac.onshape.onshape_client.oas.models.multi_part"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import parameterized_header
except ImportError:
    parameterized_header = sys.modules["omni.isaac.onshape.onshape_client.oas.models.parameterized_header"]


class FormDataBodyPart(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "form_data_content_disposition": (form_data_content_disposition.FormDataContentDisposition,),  # noqa: E501
    ...
    attribute_map = {
        ...
        "form_data_content_disposition": "formDataContentDisposition",  # noqa: E501
    ...
    def __init__(
        ...
        """form_data_body_part.FormDataBodyPart - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            form_data_content_disposition (form_data_content_disposition.FormDataContentDisposition): [optional]  # noqa: E501
            ...
            simple (bool): [optional]  # noqa: E501
