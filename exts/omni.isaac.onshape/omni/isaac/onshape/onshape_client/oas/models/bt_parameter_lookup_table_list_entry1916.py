...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_lookup_table_entry1667
except ImportError:
    bt_parameter_lookup_table_entry1667 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_lookup_table_entry1667"
    ]


class BTParameterLookupTableListEntry1916(ModelNormal):
    ...
    def __init__(
        ...
        """bt_parameter_lookup_table_list_entry1916.BTParameterLookupTableListEntry1916 - a model defined in OpenAPI
