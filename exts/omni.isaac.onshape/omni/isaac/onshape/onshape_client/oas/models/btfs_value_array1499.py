...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_array1499_all_of
except ImportError:
    btfs_value_array1499_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_array1499_all_of"
    ]
...
class BTFSValueArray1499(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value1888.BTFSValue1888, btfs_value_array1499_all_of.BTFSValueArray1499AllOf],
            "oneOf": [],
        }
