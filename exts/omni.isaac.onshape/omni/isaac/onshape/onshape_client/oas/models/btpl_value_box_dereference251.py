...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btpl_value_box_dereference251_all_of
except ImportError:
    btpl_value_box_dereference251_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btpl_value_box_dereference251_all_of"
    ]
...
class BTPLValueBoxDereference251(ModelComposed):
    ...
    def __init__(
        ...
        """btpl_value_box_dereference251.BTPLValueBoxDereference251 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btpl_value249.BTPLValue249, btpl_value_box_dereference251_all_of.BTPLValueBoxDereference251AllOf],
            "oneOf": [],
        }
