...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_constant_declaration283
except ImportError:
    btp_top_level_constant_declaration283 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_constant_declaration283"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_import285
except ImportError:
    btp_top_level_import285 = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_top_level_import285"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_top_level_node286_all_of
except ImportError:
    btp_top_level_node286_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_top_level_node286_all_of"
    ]
try:
...
class BTPTopLevelNode286(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_node7.BTPNode7, btp_top_level_node286_all_of.BTPTopLevelNode286AllOf],
            "oneOf": [],
        }
