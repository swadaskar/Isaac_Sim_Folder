...
try:
    from omni.isaac.onshape.onshape_client.oas.models import request_options
except ImportError:
    request_options = sys.modules["omni.isaac.onshape.onshape_client.oas.models.request_options"]
...
class ExternalAccountCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            "count": (int,),  # noqa: E501
            "data": ([external_account.ExternalAccount],),  # noqa: E501
    ...
    def __init__(
        ...
        """external_account_collection.ExternalAccountCollection - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ([external_account.ExternalAccount]): [optional]  # noqa: E501
