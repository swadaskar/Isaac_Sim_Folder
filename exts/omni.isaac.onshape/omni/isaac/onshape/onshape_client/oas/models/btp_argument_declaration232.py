...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_argument_declaration232_all_of
except ImportError:
    btp_argument_declaration232_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_argument_declaration232_all_of"
    ]
try:
...
class BTPArgumentDeclaration232(ModelComposed):
    ...
    def __init__(
        ...
        """btp_argument_declaration232.BTPArgumentDeclaration232 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_argument_declaration232_all_of.BTPArgumentDeclaration232AllOf, btp_node7.BTPNode7],
            "oneOf": [],
        }
