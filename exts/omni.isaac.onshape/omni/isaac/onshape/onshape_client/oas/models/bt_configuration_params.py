...
try:
    from omni.isaac.onshape.onshape_client.oas.models import configuration_entry
except ImportError:
    configuration_entry = sys.modules["omni.isaac.onshape.onshape_client.oas.models.configuration_entry"]
...
class BTConfigurationParams(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            "parameters": ([configuration_entry.ConfigurationEntry],),  # noqa: E501
    ...
    def __init__(
        ...
        """bt_configuration_params.BTConfigurationParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            parameters ([configuration_entry.ConfigurationEntry]): [optional]  # noqa: E501
