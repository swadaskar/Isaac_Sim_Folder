...
class BTMConfigurationParameterQuantity1826AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btm_configuration_parameter_quantity1826_all_of.BTMConfigurationParameterQuantity1826AllOf - a model defined in OpenAPI
