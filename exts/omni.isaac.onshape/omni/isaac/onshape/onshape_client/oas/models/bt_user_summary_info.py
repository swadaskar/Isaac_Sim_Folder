...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_user_summary_info_all_of
except ImportError:
    bt_user_summary_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_user_summary_info_all_of"
    ]
try:
...
class BTUserSummaryInfo(ModelComposed):
    ...
    def __init__(
        ...
        """bt_user_summary_info.BTUserSummaryInfo - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                bt_user_summary_info_all_of.BTUserSummaryInfoAllOf,
            ],
            "oneOf": [],
        }
