...
class BTPStatementConstantDeclaration273AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """btp_statement_constant_declaration273_all_of.BTPStatementConstantDeclaration273AllOf - a model defined in OpenAPI
