...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_string1422_all_of
except ImportError:
    btfs_value_string1422_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_string1422_all_of"
    ]
...
class BTFSValueString1422(ModelComposed):
    ...
    def __init__(
        ...
        """btfs_value_string1422.BTFSValueString1422 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value_object (str): [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value1888.BTFSValue1888, btfs_value_string1422_all_of.BTFSValueString1422AllOf],
            "oneOf": [],
        }
