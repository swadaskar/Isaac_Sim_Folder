...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_export_model_arc_edge_geometry1257_all_of
except ImportError:
    bt_export_model_arc_edge_geometry1257_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_export_model_arc_edge_geometry1257_all_of"
    ]
try:
