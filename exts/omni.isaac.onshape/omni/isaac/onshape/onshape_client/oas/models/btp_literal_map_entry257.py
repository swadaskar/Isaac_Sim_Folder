...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_map_entry257_all_of
except ImportError:
    btp_literal_map_entry257_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_literal_map_entry257_all_of"
    ]
try:
...
class BTPLiteralMapEntry257(ModelComposed):
    ...
    def __init__(
        ...
        """btp_literal_map_entry257.BTPLiteralMapEntry257 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_literal_map_entry257_all_of.BTPLiteralMapEntry257AllOf, btp_node7.BTPNode7],
            "oneOf": [],
        }
