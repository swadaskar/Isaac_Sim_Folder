...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_table_cell_parameter2399
except ImportError:
    bt_table_cell_parameter2399 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_table_cell_parameter2399"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_table_cell_property_parameter2983_all_of
except ImportError:
    bt_table_cell_property_parameter2983_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_table_cell_property_parameter2983_all_of"
    ]
try:
...
class BTTableCellPropertyParameter2983(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_table_cell_parameter2399.BTTableCellParameter2399,
                bt_table_cell_property_parameter2983_all_of.BTTableCellPropertyParameter2983AllOf,
            ],
            "oneOf": [],
        }
