...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_curve_geometry_interpolated_spline116_all_of
except ImportError:
    bt_curve_geometry_interpolated_spline116_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_curve_geometry_interpolated_spline116_all_of"
    ]


class BTCurveGeometryInterpolatedSpline116(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            ...
            "allOf": [
                ...
                bt_curve_geometry_interpolated_spline116_all_of.BTCurveGeometryInterpolatedSpline116AllOf,
            ],
            "oneOf": [],
        }
