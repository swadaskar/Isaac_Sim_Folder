...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_expression_group241_all_of
except ImportError:
    btp_expression_group241_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_expression_group241_all_of"
    ]
try:
...
class BTPExpressionGroup241(ModelComposed):
    ...
    def __init__(
        ...
        """btp_expression_group241.BTPExpressionGroup241 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_expression9.BTPExpression9, btp_expression_group241_all_of.BTPExpressionGroup241AllOf],
            "oneOf": [],
        }
