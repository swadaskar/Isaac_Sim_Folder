...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_statement_if276_all_of
except ImportError:
    btp_statement_if276_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.btp_statement_if276_all_of"]


class BTPStatementIf276(ModelComposed):
    ...
    def __init__(
        ...
        """btp_statement_if276.BTPStatementIf276 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_statement269.BTPStatement269, btp_statement_if276_all_of.BTPStatementIf276AllOf],
            "oneOf": [],
        }
