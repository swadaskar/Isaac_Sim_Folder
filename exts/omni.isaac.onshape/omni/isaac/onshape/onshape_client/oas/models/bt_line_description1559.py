...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_line_description1559_all_of
except ImportError:
    bt_line_description1559_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_line_description1559_all_of"
    ]
try:
