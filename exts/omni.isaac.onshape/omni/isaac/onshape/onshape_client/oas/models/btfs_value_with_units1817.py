...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_with_units1817_all_of
except ImportError:
    btfs_value_with_units1817_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_with_units1817_all_of"
    ]
...
class BTFSValueWithUnits1817(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value1888.BTFSValue1888, btfs_value_with_units1817_all_of.BTFSValueWithUnits1817AllOf],
            "oneOf": [],
        }
