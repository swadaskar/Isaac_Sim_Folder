...
try:
    from omni.isaac.onshape.onshape_client.oas.models import external_documentation
except ImportError:
    external_documentation = sys.modules["omni.isaac.onshape.onshape_client.oas.models.external_documentation"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import security_requirement
except ImportError:
    security_requirement = sys.modules["omni.isaac.onshape.onshape_client.oas.models.security_requirement"]
try:
    from omni.isaac.onshape.onshape_client.oas.models import server
except ImportError:
    server = sys.modules["omni.isaac.onshape.onshape_client.oas.models.server"]
