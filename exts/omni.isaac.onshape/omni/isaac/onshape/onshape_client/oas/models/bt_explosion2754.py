...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_explosion2754_all_of
except ImportError:
    bt_explosion2754_all_of = sys.modules["omni.isaac.onshape.onshape_client.oas.models.bt_explosion2754_all_of"]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_microversion_id_and_configuration2338
except ImportError:
    bt_microversion_id_and_configuration2338 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_microversion_id_and_configuration2338"
    ]
try:
...
class BTExplosion2754(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_explosion2754_all_of.BTExplosion2754AllOf, btm_assembly_feature887.BTMAssemblyFeature887],
            "oneOf": [],
        }
