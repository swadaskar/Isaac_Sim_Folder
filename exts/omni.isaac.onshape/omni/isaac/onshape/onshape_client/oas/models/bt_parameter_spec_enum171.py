...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_parameter_spec_enum171_all_of
except ImportError:
    bt_parameter_spec_enum171_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_parameter_spec_enum171_all_of"
    ]
try:
...
class BTParameterSpecEnum171(ModelComposed):
    ...
    def __init__(
        ...
        """bt_parameter_spec_enum171.BTParameterSpecEnum171 - a model defined in OpenAPI
