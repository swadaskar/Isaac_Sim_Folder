...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_company_user_summary_admin_info
except ImportError:
    bt_company_user_summary_admin_info = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_company_user_summary_admin_info"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_company_user_summary_info_all_of
except ImportError:
    bt_company_user_summary_info_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_company_user_summary_info_all_of"
    ]
try:
