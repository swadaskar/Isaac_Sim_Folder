...
from omni.isaac.onshape.onshape_client.oas.model_utils import ModelNormal, file_type, int, str  # noqa: F401
...
class BTTranslationRequestBean(ModelNormal):
    ...
    def __init__(
        ...
        """bt_translation_request_bean.BTTranslationRequestBean - a model defined in OpenAPI
