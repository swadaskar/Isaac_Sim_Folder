...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btp_literal_array254_all_of
except ImportError:
    btp_literal_array254_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btp_literal_array254_all_of"
    ]
try:
...
class BTPLiteralArray254(ModelComposed):
    ...
    def __init__(
        ...
        """btp_literal_array254.BTPLiteralArray254 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_literal253.BTPLiteral253, btp_literal_array254_all_of.BTPLiteralArray254AllOf],
            "oneOf": [],
        }
