...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btfs_value_number772_all_of
except ImportError:
    btfs_value_number772_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btfs_value_number772_all_of"
    ]


class BTFSValueNumber772(ModelComposed):
    ...
    def __init__(
        ...
        """btfs_value_number772.BTFSValueNumber772 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btfs_value1888.BTFSValue1888, btfs_value_number772_all_of.BTFSValueNumber772AllOf],
            "oneOf": [],
        }
