...
class BTInnerArrayParameterLocation2368AllOf(ModelNormal):
    ...
    def __init__(
        ...
        """bt_inner_array_parameter_location2368_all_of.BTInnerArrayParameterLocation2368AllOf - a model defined in OpenAPI
