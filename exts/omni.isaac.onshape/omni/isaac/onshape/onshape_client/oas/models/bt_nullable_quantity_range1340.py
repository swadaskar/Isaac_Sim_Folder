...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_nullable_quantity_range1340_all_of
except ImportError:
    bt_nullable_quantity_range1340_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_nullable_quantity_range1340_all_of"
    ]
try:
...
class BTNullableQuantityRange1340(ModelComposed):
    ...
    def __init__(
        ...
        """bt_nullable_quantity_range1340.BTNullableQuantityRange1340 - a model defined in OpenAPI
