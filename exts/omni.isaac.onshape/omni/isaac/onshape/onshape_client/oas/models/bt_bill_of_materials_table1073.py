...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_bill_of_materials_table1073_all_of
except ImportError:
    bt_bill_of_materials_table1073_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_bill_of_materials_table1073_all_of"
    ]
try:
...
class BTBillOfMaterialsTable1073(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [bt_bill_of_materials_table1073_all_of.BTBillOfMaterialsTable1073AllOf, bt_table1825.BTTable1825],
            "oneOf": [],
        }
