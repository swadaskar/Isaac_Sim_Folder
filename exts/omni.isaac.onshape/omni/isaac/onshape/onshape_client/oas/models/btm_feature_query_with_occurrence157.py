...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_feature_query_with_occurrence157_all_of
except ImportError:
    btm_feature_query_with_occurrence157_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_feature_query_with_occurrence157_all_of"
    ]
try:
...
try:
    from omni.isaac.onshape.onshape_client.oas.models import btm_part_studio_mate_connector_query1324
except ImportError:
    btm_part_studio_mate_connector_query1324 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.btm_part_studio_mate_connector_query1324"
    ]


class BTMFeatureQueryWithOccurrence157(ModelComposed):
    ...
    def discriminator():
        return {
            "bt_type": {
                "BTMPartStudioMateConnectorQuery-1324": btm_part_studio_mate_connector_query1324.BTMPartStudioMateConnectorQuery1324
            }
        }
    ...
    def __init__(
        ...
        """btm_feature_query_with_occurrence157.BTMFeatureQueryWithOccurrence157 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                btm_feature_query_with_occurrence157_all_of.BTMFeatureQueryWithOccurrence157AllOf,
