...
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_full_element_id_and_part_id643_all_of
except ImportError:
    bt_full_element_id_and_part_id643_all_of = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_full_element_id_and_part_id643_all_of"
    ]
try:
    from omni.isaac.onshape.onshape_client.oas.models import bt_full_element_id_with_document1729
except ImportError:
    bt_full_element_id_with_document1729 = sys.modules[
        "omni.isaac.onshape.onshape_client.oas.models.bt_full_element_id_with_document1729"
    ]
try:
...
class BTFullElementIdAndPartId643(ModelComposed):
    ...
    def __init__(
        ...
        """bt_full_element_id_and_part_id643.BTFullElementIdAndPartId643 - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [
                bt_full_element_id_and_part_id643_all_of.BTFullElementIdAndPartId643AllOf,
                bt_full_element_id_with_document1729.BTFullElementIdWithDocument1729,
            ],
            "oneOf": [],
        }
