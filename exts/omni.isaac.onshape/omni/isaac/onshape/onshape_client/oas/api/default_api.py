...
from omni.isaac.onshape.onshape_client.oas.models import bt_workflowable_test_object_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_basic_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_associative_data_info_array
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_insertable_info
from omni.isaac.onshape.onshape_client.oas.models import bt_metadata_schema_info
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_metadata_property_summary_info
from omni.isaac.onshape.onshape_client.oas.models import bt_metadata_property_info
from omni.isaac.onshape.onshape_client.oas.models import bt_bounding_box_info
from omni.isaac.onshape.onshape_client.oas.models import bt_update_workflowable_test_object_params
...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_workflowable_test_object = Endpoint(
            ...
            params_map={"all": ["wfid"], "required": ["wfid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        self.get_property_info = Endpoint(
            ...
            params_map={
                "all": ["pid", "document_id", "schema_id", "owner_id", "owner_type", "object_type"],
                "required": ["pid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        self.get_sketch_bounding_boxes = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "sid", "configuration", "link_document_id"],
        ...
        self.get_workflowable_test_object = Endpoint(
            ...
            params_map={"all": ["oid"], "required": ["oid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        self.post_associative_data = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "eid": (str,), "wvm": (str,), "wvmid": (str,), "body": (str,)},
                "attribute_map": {"did": "did", "eid": "eid", "wvm": "wvm", "wvmid": "wvmid"},
                "location_map": {"did": "path", "eid": "path", "wvm": "path", "wvmid": "path", "body": "body"},
                "collection_format_map": {},
            },
            headers_map={
        ...
        def __update_workflowable_test_object(self, oid, bt_update_workflowable_test_object_params, **kwargs):
            ...
            kwargs["_host_index"] = kwargs.get("_host_index", 0)
            kwargs["oid"] = oid
            kwargs["bt_update_workflowable_test_object_params"] = bt_update_workflowable_test_object_params
            return self.call_with_http_info(**kwargs)
        ...
        self.update_workflowable_test_object = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"oid": "oid"},
                "location_map": {"oid": "path", "bt_update_workflowable_test_object_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
