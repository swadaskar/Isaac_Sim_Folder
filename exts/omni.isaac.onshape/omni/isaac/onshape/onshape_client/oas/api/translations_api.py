...
from omni.isaac.onshape.onshape_client.oas.models import bt_model_format_full_info
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_translation_request_info
...
class TranslationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_translation = Endpoint(
            ...
            params_map={"all": ["tid"], "required": ["tid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
