...
from omni.isaac.onshape.onshape_client.oas.models import bt_webhook_params
from omni.isaac.onshape.onshape_client.oas.models import bt_webhook_info
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_webhook_info
...
class WebhooksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_webhook = Endpoint(
            ...
            params_map={"all": ["bt_webhook_params"], "required": [], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"bt_webhook_params": (bt_webhook_params.BTWebhookParams,)},
                "attribute_map": {},
        ...
        self.get_webhook = Endpoint(
            ...
            params_map={"all": ["webhookid"], "required": ["webhookid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        self.get_webhooks = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"company": (str,), "user": (str,), "offset": (int,), "limit": (int,)},
                "attribute_map": {"company": "company", "user": "user", "offset": "offset", "limit": "limit"},
                "location_map": {"company": "query", "user": "query", "offset": "query", "limit": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.update_webhook = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"webhookid": (str,), "bt_webhook_params": (bt_webhook_params.BTWebhookParams,)},
                "attribute_map": {"webhookid": "webhookid"},
