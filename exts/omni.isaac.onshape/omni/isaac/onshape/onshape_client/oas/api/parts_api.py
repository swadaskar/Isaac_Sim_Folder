...
from omni.isaac.onshape.onshape_client.oas.models import bt_table_response1546
...
from omni.isaac.onshape.onshape_client.oas.models import bt_part_metadata_info
from omni.isaac.onshape.onshape_client.oas.models import bt_shaded_views_info
from omni.isaac.onshape.onshape_client.oas.models import bt_workspace_part_params
...
class PartsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_ps = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "partid", "version", "configuration", "link_document_id"],
        ...
        self.get_body_details = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "partid", "configuration", "link_document_id"],
                "required": ["did", "wvm", "wvmid", "eid", "partid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        self.get_bounding_boxes = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "partid", "include_hidden", "configuration", "link_document_id"],
                "required": ["did", "wvm", "wvmid", "eid", "partid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        def __get_standard_content_part_metadata(self, did, vid, eid, otype, oid, partid, **kwargs):
        ...
        self.update_part_metadata = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "partid", "bt_workspace_part_params"],
                "required": ["did", "wvm", "wvmid", "eid", "partid"],
                "nullable": [],
                "enum": [],
                "validation": [],
            ...
            root_map={
                ...
                "openapi_types": {
                    ...
                    "eid": (str,),
                    "partid": (str,),
                    "bt_workspace_part_params": (bt_workspace_part_params.BTWorkspacePartParams,),
                },
                "attribute_map": {"did": "did", "wvm": "wvm", "wvmid": "wvmid", "eid": "eid", "partid": "partid"},
                "location_map": {
                    "did": "path",
                    "wvm": "path",
                    "wvmid": "path",
        ...
        def __update_standard_content_part_metadata(self, did, vid, eid, otype, oid, partid, **kwargs):
