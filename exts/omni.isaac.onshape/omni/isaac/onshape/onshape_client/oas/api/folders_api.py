...
class FoldersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_folder_acl = Endpoint(
            ...
            params_map={"all": ["fid"], "required": ["fid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"fid": (str,)},
                "attribute_map": {"fid": "fid"},
                "location_map": {"fid": "path"},
        ...
        self.share = Endpoint(
            ...
            params_map={
                "all": ["fid", "bt_share_params"],
                "required": ["fid", "bt_share_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"fid": (str,), "bt_share_params": (bt_share_params.BTShareParams,)},
                "attribute_map": {"fid": "fid"},
                "location_map": {"fid": "path", "bt_share_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
        ...
        self.un_share = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"fid": (str,), "eid": (str,), "entry_type": (int,)},
                "attribute_map": {"fid": "fid", "eid": "eid", "entry_type": "entryType"},
                "location_map": {"fid": "path", "eid": "path", "entry_type": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
