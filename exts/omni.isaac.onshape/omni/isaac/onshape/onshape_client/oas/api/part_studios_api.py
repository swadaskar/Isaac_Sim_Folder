...
from omni.isaac.onshape.onshape_client.oas.models import bt_root_diff_info
...
from omni.isaac.onshape.onshape_client.oas.models import bt_feature_script_eval_response1859
from omni.isaac.onshape.onshape_client.oas.models import bt_feature_script_eval_call2377
from omni.isaac.onshape.onshape_client.oas.models import bt_export_model_bodies_response734
...
from omni.isaac.onshape.onshape_client.oas.models import bt_feature_list_response2457
from omni.isaac.onshape.onshape_client.oas.models import bt_mass_properties_bulk_info
...
from omni.isaac.onshape.onshape_client.oas.models import bt_export_tessellated_edges_response327
from omni.isaac.onshape.onshape_client.oas.models import bt_export_tessellated_faces_response898
from omni.isaac.onshape.onshape_client.oas.models import bt_id_translation_params
from omni.isaac.onshape.onshape_client.oas.models import bt_id_translation_info
from omni.isaac.onshape.onshape_client.oas.models import bt_update_features_response1333
from omni.isaac.onshape.onshape_client.oas.models import bt_configuration_response2019
from omni.isaac.onshape.onshape_client.oas.models import bt_set_feature_rollback_response1042
    ...
    def __init__(self, api_client=None):
        ...
        self.add_part_studio_feature = Endpoint(
            ...
            headers_map={
                ...
                "content_type": ["application/vnd.onshape.v2+json;charset=UTF-8;qs=0.2"],
            },
        ...
        self.compare_part_studios = Endpoint(
            ...
            headers_map={"accept": ["application/json;charset=UTF-8; qs=0.09"], "content_type": []},
            api_client=api_client,
        ...
        def __create_part_studio_translation(self, did, wv, wvid, eid, bt_translate_format_params, **kwargs):
        ...
        self.eval_feature_script = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "configuration", "bt_feature_script_eval_call_2377"],
                "required": ["did", "wvm", "wvmid", "eid"],
                "nullable": [],
                "enum": [],
                "validation": [],
            ...
            root_map={
                ...
                "openapi_types": {
                    ...
                    "eid": (str,),
                    "configuration": (str,),
                    "bt_feature_script_eval_call_2377": (bt_feature_script_eval_call2377.BTFeatureScriptEvalCall2377,),
                },
                "attribute_map": {
                    "did": "did",
                    "wvm": "wvm",
        ...
        self.get_part_studio_features = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "feature_id", "link_document_id", "no_sketch_geometry"],
                "required": ["did", "wvm", "wvmid", "eid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        self.get_part_studio_mass_properties = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "part_id", "mass_as_group", "configuration", "link_document_id"],
                "required": ["did", "wvm", "wvmid", "eid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        self.get_part_studio_named_views = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "skip_perspective", "include_section_cut_views", "link_document_id"],
                "required": ["did", "eid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        def __translate_ids(self, did, wvm, wvmid, eid, bt_id_translation_params, **kwargs):
        ...
        self.update_features = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "wid": (str,), "eid": (str,), "body": (str,)},
                "attribute_map": {"did": "did", "wid": "wid", "eid": "eid"},
                "location_map": {"did": "path", "wid": "path", "eid": "path", "body": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/json;charset=UTF-8; qs=0.09"],
        ...
        self.update_part_studio_configuration = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "wvm": (str,), "wvmid": (str,), "eid": (str,), "body": (str,)},
                "attribute_map": {"did": "did", "wvm": "wvm", "wvmid": "wvmid", "eid": "eid"},
                "location_map": {"did": "path", "wvm": "path", "wvmid": "path", "eid": "path", "body": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/json;charset=UTF-8; qs=0.09"],
