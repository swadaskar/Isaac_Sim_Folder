...
class FeatureStudiosApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_feature_studio(self, did, wid, bt_model_element_params, **kwargs):
        ...
        def __get_feature_studio_contents(self, did, wvm, wvmid, eid, **kwargs):
        ...
        self.get_feature_studio_contents = Endpoint(
            settings={
                "response_type": (bt_feature_studio_contents2239.BTFeatureStudioContents2239,),
                "auth": ["OAuth2"],
                "endpoint_path": "/api/featurestudios/d/{did}/{wvm}/{wvmid}/e/{eid}",
        ...
        self.get_feature_studio_specs = Endpoint(
            settings={
                ...
                "auth": ["OAuth2"],
                "endpoint_path": "/api/featurestudios/d/{did}/{wvm}/{wvmid}/e/{eid}/featurespecs",
        ...
        def __update_feature_studio_contents(self, did, wvm, wvmid, eid, **kwargs):
