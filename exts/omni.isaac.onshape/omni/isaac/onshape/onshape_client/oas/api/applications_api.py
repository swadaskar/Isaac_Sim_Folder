...
from omni.isaac.onshape.onshape_client.oas.models import bt_user_app_settings_info
from omni.isaac.onshape.onshape_client.oas.models import bt_user_app_settings_params
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_app_settings = Endpoint(
            settings={
                "response_type": None,
                "auth": [],
                "endpoint_path": "/api/applications/clients/{cid}/settings/users/{uid}",
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"uid": (str,), "cid": (str,), "key": ([str],)},
                "attribute_map": {"uid": "uid", "cid": "cid", "key": "key"},
                "location_map": {"uid": "path", "cid": "path", "key": "query"},
                "collection_format_map": {"key": "multi"},
            },
        ...
        self.get_user_app_settings = Endpoint(
            settings={
                "response_type": (bt_user_app_settings_info.BTUserAppSettingsInfo,),
                "auth": [],
                "endpoint_path": "/api/applications/clients/{cid}/settings/users/{uid}",
        ...
        def __update_app_settings(self, uid, cid, bt_user_app_settings_params, **kwargs):
        ...
        self.update_app_settings = Endpoint(
            ...
            params_map={
                "all": ["uid", "cid", "bt_user_app_settings_params"],
                "required": ["uid", "cid", "bt_user_app_settings_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                ...
                "attribute_map": {"uid": "uid", "cid": "cid"},
                "location_map": {"uid": "path", "cid": "path", "bt_user_app_settings_params": "body"},
                "collection_format_map": {},
            },
            headers_map={"accept": [], "content_type": ["application/json;charset=UTF-8; qs=0.09"]},
            api_client=api_client,
