...
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_revision_info
from omni.isaac.onshape.onshape_client.oas.models import bt_revision_info
...
class RevisionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.enumerate_revisions = Endpoint(
            ...
            params_map={
                "all": ["cid", "element_type", "limit", "offset", "latest_only", "after"],
                "required": ["cid"],
                "nullable": [],
                "enum": [],
                "validation": [],
        ...
        self.get_latest_in_document_or_company = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"cd": (str,), "cdid": (str,), "pnum": (str,), "et": (str,)},
                "attribute_map": {"cd": "cd", "cdid": "cdid", "pnum": "pnum", "et": "et"},
                "location_map": {"cd": "path", "cdid": "path", "pnum": "path", "et": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.get_revision_history_in_company = Endpoint(
            ...
            params_map={
                "all": ["cid", "pnum", "element_type", "fill_approvers", "fill_export_permission"],
                "required": ["cid", "pnum"],
                "nullable": [],
                "enum": [],
                "validation": [],
