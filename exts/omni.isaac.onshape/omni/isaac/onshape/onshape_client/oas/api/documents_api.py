...
from omni.isaac.onshape.onshape_client.oas.models import bt_copy_document_params
from omni.isaac.onshape.onshape_client.oas.models import bt_copy_document_info
from omni.isaac.onshape.onshape_client.oas.models import bt_document_params
from omni.isaac.onshape.onshape_client.oas.models import bt_document_info
from omni.isaac.onshape.onshape_client.oas.models import bt_version_or_workspace_params
from omni.isaac.onshape.onshape_client.oas.models import bt_version_info
from omni.isaac.onshape.onshape_client.oas.models import bt_workspace_info
from omni.isaac.onshape.onshape_client.oas.models import bt_export_model_params
from omni.isaac.onshape.onshape_client.oas.models import bt_microversion_info
from omni.isaac.onshape.onshape_client.oas.models import bt_acl_info
from omni.isaac.onshape.onshape_client.oas.models import bt_global_tree_node_list_response
from omni.isaac.onshape.onshape_client.oas.models import bt_document_element_info
from omni.isaac.onshape.onshape_client.oas.models import bt_insertables_list_response
from omni.isaac.onshape.onshape_client.oas.models import bt_version_or_workspace_info
from omni.isaac.onshape.onshape_client.oas.models import bt_document_merge_info
from omni.isaac.onshape.onshape_client.oas.models import bt_move_element_info
from omni.isaac.onshape.onshape_client.oas.models import bt_move_element_params
from omni.isaac.onshape.onshape_client.oas.models import bt_document_search_params
from omni.isaac.onshape.onshape_client.oas.models import bt_share_params
from omni.isaac.onshape.onshape_client.oas.models import bt_link_to_latest_document_params
from omni.isaac.onshape.onshape_client.oas.models import bt_link_to_latest_document_info
    ...
    def __init__(self, api_client=None):
        ...
        self.copy_workspace = Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    "did": (str,),
                    "wid": (str,),
                    "bt_copy_document_params": (bt_copy_document_params.BTCopyDocumentParams,),
                },
                "attribute_map": {"did": "did", "wid": "wid"},
                "location_map": {"did": "path", "wid": "path", "bt_copy_document_params": "body"},
        ...
        self.create_document = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"bt_document_params": (bt_document_params.BTDocumentParams,)},
                "attribute_map": {},
        ...
        self.create_version = Endpoint(
            ...
            root_map={
                ...
                "location_map": {"did": "path", "bt_version_or_workspace_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        self.delete_document = Endpoint(
            ...
            params_map={"all": ["did", "forever"], "required": ["did"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        self.download_external_data = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "fid": (str,), "if_none_match": (str,)},
                "attribute_map": {"did": "did", "fid": "fid", "if_none_match": "If-None-Match"},
                "location_map": {"did": "path", "fid": "path", "if_none_match": "header"},
                "collection_format_map": {},
            },
            headers_map={
        ...
        self.export2_json = Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    ...
                    "wvid": (str,),
                    "eid": (str,),
                    "bt_export_model_params": (bt_export_model_params.BTExportModelParams,),
                },
        ...
        self.get_document = Endpoint(
            ...
            params_map={"all": ["did"], "required": ["did"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        self.get_elements_in_document = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "element_type", "element_id", "with_thumbnails", "link_document_id"],
        ...
        self.get_version = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "vid": (str,), "parents": (bool,), "link_document_id": (str,)},
                "attribute_map": {
                    "did": "did",
                    "vid": "vid",
                    "parents": "parents",
                ...
                "location_map": {"did": "path", "vid": "path", "parents": "query", "link_document_id": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        def __merge_into_workspace(self, did, wid, bt_version_or_workspace_info, **kwargs):
        ...
        self.merge_into_workspace = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"did": "did", "wid": "wid"},
                "location_map": {"did": "path", "wid": "path", "bt_version_or_workspace_info": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        def __move_elements_to_document(self, did, wid, bt_move_element_params, **kwargs):
        ...
        self.move_elements_to_document = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"did": "did", "wid": "wid"},
                "location_map": {"did": "path", "wid": "path", "bt_move_element_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        self.restore_from_history = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "wid": (str,), "vm": (str,), "vmid": (str,)},
                "attribute_map": {"did": "did", "wid": "wid", "vm": "vm", "vmid": "vmid"},
                "location_map": {"did": "path", "wid": "path", "vm": "path", "vmid": "path"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.search = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"bt_document_search_params": (bt_document_search_params.BTDocumentSearchParams,)},
                "attribute_map": {},
        ...
        self.share_document = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "bt_share_params": (bt_share_params.BTShareParams,)},
                "attribute_map": {"did": "did"},
        ...
        def __sync_application_elements(self, did, wid, application_element_ids, **kwargs):
        ...
        self.un_share_document = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"did": "did", "eid": "eid", "entry_type": "entryType"},
        ...
        self.update_document_attributes = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "bt_document_params": (bt_document_params.BTDocumentParams,)},
                "attribute_map": {"did": "did"},
        ...
        def __update_external_references_to_latest_documents(self, did, wid, eid, **kwargs):
