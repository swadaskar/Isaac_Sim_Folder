...
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_company_info
from omni.isaac.onshape.onshape_client.oas.models import bt_company_info
...
class CompaniesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_company = Endpoint(
            settings={
                "response_type": (bt_list_response_bt_company_info.BTListResponseBTCompanyInfo,),
                "auth": [],
                "endpoint_path": "/api/companies",
                "operation_id": "find_company",
                "http_method": "GET",
                "servers": [],
            },
            params_map={
                "all": ["uid", "active_only", "include_all"],
                "required": [],
                "nullable": [],
                "enum": [],
                "validation": [],
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"uid": (str,), "active_only": (bool,), "include_all": (bool,)},
                "attribute_map": {"uid": "uid", "active_only": "activeOnly", "include_all": "includeAll"},
                "location_map": {"uid": "query", "active_only": "query", "include_all": "query"},
        ...
        self.get_company = Endpoint(
            ...
            params_map={"all": ["cid"], "required": ["cid"], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
