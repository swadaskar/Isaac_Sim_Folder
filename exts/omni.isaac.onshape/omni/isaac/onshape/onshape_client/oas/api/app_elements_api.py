...
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_modify_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_commit_transaction_params
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_params
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_reference_params
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_reference_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_history_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_content_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_reference_resolve_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_references_resolve_info
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_start_transaction_params
from omni.isaac.onshape.onshape_client.oas.models import bt_app_element_update_params
...
class AppElementsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __commit_transaction(self, did, eid, wid, tid, bt_app_element_commit_transaction_params, **kwargs):
            ...
            kwargs["wid"] = wid
            kwargs["tid"] = tid
            kwargs["bt_app_element_commit_transaction_params"] = bt_app_element_commit_transaction_params
        ...
        self.commit_transaction = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "wid", "tid", "bt_app_element_commit_transaction_params"],
                "required": ["did", "eid", "wid", "tid", "bt_app_element_commit_transaction_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                ...
                "attribute_map": {"did": "did", "eid": "eid", "wid": "wid", "tid": "tid"},
                "location_map": {
                    "did": "path",
                    "eid": "path",
                    "wid": "path",
        ...
        self.create_element = Endpoint(
            ...
            root_map={
                ...
                "location_map": {"did": "path", "wid": "path", "bt_app_element_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        def __create_reference(self, did, eid, wvm, wvmid, bt_app_element_reference_params, **kwargs):
        ...
        self.create_reference = Endpoint(
            settings={
                "response_type": (bt_app_element_reference_info.BTAppElementReferenceInfo,),
                "auth": ["OAuth2"],
            ...
            params_map={
                "all": ["did", "eid", "wvm", "wvmid", "bt_app_element_reference_params"],
                "required": ["did", "eid", "wvm", "wvmid", "bt_app_element_reference_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                ...
                "attribute_map": {"did": "did", "eid": "eid", "wvm": "wvm", "wvmid": "wvmid"},
                "location_map": {
                    "did": "path",
                    "eid": "path",
                    "wvm": "path",
        ...
        self.delete_app_element_content = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "wvm", "wvmid", "sid", "transaction_id", "parent_change_id", "description"],
        ...
        self.delete_reference = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "wvm", "wvmid", "rid", "transaction_id", "parent_change_id", "description"],
        ...
        self.get_app_element_history = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "eid": (str,), "wvm": (str,), "wvmid": (str,)},
                "attribute_map": {"did": "did", "eid": "eid", "wvm": "wvm", "wvmid": "wvmid"},
                "location_map": {"did": "path", "eid": "path", "wvm": "path", "wvmid": "path"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.resolve_reference = Endpoint(
            settings={
                "response_type": (bt_app_element_reference_resolve_info.BTAppElementReferenceResolveInfo,),
                "auth": ["OAuth2"],
                "endpoint_path": "/api/appelements/d/{did}/{wvm}/{wvmid}/e/{eid}/references/{rid}",
        ...
        self.resolve_references = Endpoint(
            settings={
                "response_type": (bt_app_element_references_resolve_info.BTAppElementReferencesResolveInfo,),
                "auth": ["OAuth2"],
        ...
        def __start_transaction(self, did, eid, wid, bt_app_element_start_transaction_params, **kwargs):
            ...
            kwargs["eid"] = eid
            kwargs["wid"] = wid
            kwargs["bt_app_element_start_transaction_params"] = bt_app_element_start_transaction_params
            return self.call_with_http_info(**kwargs)
        ...
        self.start_transaction = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "wid", "bt_app_element_start_transaction_params"],
                "required": ["did", "eid", "wid", "bt_app_element_start_transaction_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __update_app_element(self, did, eid, wvm, wvmid, bt_app_element_update_params, **kwargs):
        ...
        self.update_app_element = Endpoint(
            ...
            params_map={
                ...
                "required": ["did", "eid", "wvm", "wvmid", "bt_app_element_update_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __update_reference(self, did, eid, wvm, wvmid, rid, bt_app_element_reference_params, **kwargs):
        ...
        self.update_reference = Endpoint(
            ...
            params_map={
                "all": ["did", "eid", "wvm", "wvmid", "rid", "bt_app_element_reference_params"],
                "required": ["did", "eid", "wvm", "wvmid", "rid", "bt_app_element_reference_params"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                ...
                "attribute_map": {"did": "did", "eid": "eid", "wvm": "wvm", "wvmid": "wvmid", "rid": "rid"},
                "location_map": {
                    "did": "path",
                    "eid": "path",
                    "wvm": "path",
