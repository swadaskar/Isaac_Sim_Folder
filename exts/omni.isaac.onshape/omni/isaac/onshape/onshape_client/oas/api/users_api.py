...
from omni.isaac.onshape.onshape_client.oas.models import bt_user_settings_info
from omni.isaac.onshape.onshape_client.oas.models import bt_user_o_auth2_summary_info
    ...
    def __init__(self, api_client=None):
        ...
        self.get_user_settings = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"uid": (str,), "includematerials": (bool,)},
                "attribute_map": {"uid": "uid", "includematerials": "includematerials"},
                "location_map": {"uid": "path", "includematerials": "query"},
        ...
        self.get_user_settings_current_logged_in_user = Endpoint(
            ...
            params_map={"all": ["includematerials"], "required": [], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"includematerials": (bool,)},
                "attribute_map": {"includematerials": "includematerials"},
                "location_map": {"includematerials": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.session_info = Endpoint(
            settings={
                "response_type": (bt_user_o_auth2_summary_info.BTUserOAuth2SummaryInfo,),
                "auth": [],
                "endpoint_path": "/api/users/sessioninfo",
