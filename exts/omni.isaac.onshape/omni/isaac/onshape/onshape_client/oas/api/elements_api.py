...
from omni.isaac.onshape.onshape_client.oas.models import bt_copy_element_params
from omni.isaac.onshape.onshape_client.oas.models import bt_document_element_info
from omni.isaac.onshape.onshape_client.oas.models import bt_configuration_info
from omni.isaac.onshape.onshape_client.oas.models import bt_encoded_configuration_info
from omni.isaac.onshape.onshape_client.oas.models import bt_configuration_params
from omni.isaac.onshape.onshape_client.oas.models import bt_model_format_info
from omni.isaac.onshape.onshape_client.oas.models import bt_update_reference_params
...
class ElementsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __copy_element_from_source_document(self, did, wid, bt_copy_element_params, **kwargs):
        ...
        self.copy_element_from_source_document = Endpoint(
            ...
            root_map={
                ...
                "location_map": {"did": "path", "wid": "path", "bt_copy_element_params": "body"},
        ...
        def __encode_configuration_map(self, did, eid, bt_configuration_params, **kwargs):
        ...
        self.encode_configuration_map = Endpoint(
            settings={
                "response_type": (bt_encoded_configuration_info.BTEncodedConfigurationInfo,),
                "auth": ["OAuth2"],
            ...
            params_map={
                "all": ["did", "eid", "bt_configuration_params", "version_id", "link_document_id"],
        ...
        def __get_element_translator_formats_by_version_or_workspace(self, did, wv, wvid, eid, **kwargs):
        ...
        def __update_references(self, did, wid, eid, bt_update_reference_params, **kwargs):
        ...
        self.update_references = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"did": "did", "wid": "wid", "eid": "eid"},
                "location_map": {"did": "path", "wid": "path", "eid": "path", "bt_update_reference_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
