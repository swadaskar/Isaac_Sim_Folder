...
from omni.isaac.onshape.onshape_client.oas.models import bt_purchase_user_params
from omni.isaac.onshape.onshape_client.oas.models import bt_purchase_info
from omni.isaac.onshape.onshape_client.oas.models import bt_list_response_bt_purchase_info
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_purchase_new = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"aid": (str,), "pid": (str,), "cancel_immediately": (bool,)},
                "attribute_map": {"aid": "aid", "pid": "pid", "cancel_immediately": "cancelImmediately"},
                "location_map": {"aid": "path", "pid": "path", "cancel_immediately": "query"},
        ...
        self.consume_purchase = Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    "pid": (str,),
                    "bt_purchase_user_params": (bt_purchase_user_params.BTPurchaseUserParams,),
                },
        ...
        self.get_plan_purchases = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"plan_id": (str,), "offset": (int,), "limit": (int,)},
                "attribute_map": {"plan_id": "planId", "offset": "offset", "limit": "limit"},
                "location_map": {"plan_id": "path", "offset": "query", "limit": "query"},
                "collection_format_map": {},
            },
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
        ...
        self.get_purchases = Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {"all": "all", "own_purchase_only": "ownPurchaseOnly"},
