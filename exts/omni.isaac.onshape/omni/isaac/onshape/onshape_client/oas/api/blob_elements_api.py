...
from omni.isaac.onshape.onshape_client.oas.models import bt_document_element_processing_info
from omni.isaac.onshape.onshape_client.oas.models import bt_update_mesh_units_params
from omni.isaac.onshape.onshape_client.oas.models import form_data_body_part
from omni.isaac.onshape.onshape_client.oas.models import form_data_content_disposition
...
class BlobElementsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_blob_translation(self, did, wv, wvid, eid, bt_translate_format_params, **kwargs):
        ...
        self.download_file_workspace = Endpoint(
            ...
            params_map={
                "all": ["did", "wid", "eid", "content_disposition", "if_none_match", "link_document_id"],
        ...
        self.update_units = Endpoint(
            ...
            root_map={
                ...
                "location_map": {"did": "path", "eid": "path", "wid": "path", "bt_update_mesh_units_params": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        self.upload_file_create_element = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {("owner_type",): {"USER": "USER", "COMPANY": "COMPANY", "ONSHAPE": "ONSHAPE"}},
                "openapi_types": {
                    "did": (str,),
                    "wid": (str,),
                    ...
                    "file_detail": (form_data_content_disposition.FormDataContentDisposition,),
        ...
        self.upload_file_update_element = Endpoint(
            ...
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "eid": (str,), "wid": (str,), "parent_change_id": (str,)},
                "attribute_map": {"did": "did", "eid": "eid", "wid": "wid", "parent_change_id": "parentChangeId"},
                "location_map": {"did": "path", "eid": "path", "wid": "path", "parent_change_id": "query"},
                "collection_format_map": {},
            },
