...
from omni.isaac.onshape.onshape_client.oas.models import bt_release_package_params
from omni.isaac.onshape.onshape_client.oas.models import bt_active_workflow_info
from omni.isaac.onshape.onshape_client.oas.models import bt_release_package_info
from omni.isaac.onshape.onshape_client.oas.models import bt_update_release_package_params
...
class ReleaseManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_company_release_workflow = Endpoint(
            ...
            params_map={"all": ["document_id"], "required": [], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
        ...
        def __update_release_package(self, rpid, bt_update_release_package_params, **kwargs):
            ...
            kwargs["_host_index"] = kwargs.get("_host_index", 0)
            kwargs["rpid"] = rpid
            kwargs["bt_update_release_package_params"] = bt_update_release_package_params
            return self.call_with_http_info(**kwargs)
        ...
        self.update_release_package = Endpoint(
            ...
            params_map={
                "all": ["rpid", "bt_update_release_package_params", "action", "wfaction"],
            ...
            root_map={
                ...
                "attribute_map": {"rpid": "rpid", "action": "action", "wfaction": "wfaction"},
                "location_map": {
                    "rpid": "path",
