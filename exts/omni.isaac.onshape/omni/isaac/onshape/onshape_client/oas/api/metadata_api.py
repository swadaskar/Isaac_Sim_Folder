...
class MetadataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_veop_standard_content_metadata(self, did, vid, eid, otype, oid, pid, **kwargs):
        ...
        self.get_veop_standard_content_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/standardcontent/d/{did}/v/{vid}/e/{eid}/{otype}/{oid}/p/{pid}",
                "operation_id": "get_veop_standard_content_metadata",
                "http_method": "GET",
                "servers": [],
            },
            params_map={
                "all": ["did", "vid", "eid", "otype", "oid", "pid", "configuration", "link_document_id", "thumbnail"],
                "required": ["did", "vid", "eid", "otype", "oid", "pid"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __get_wmv_es_metadata(self, did, wvm, wvmid, **kwargs):
            """get_wmv_es_metadata  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.get_wmv_es_metadata(did, wvm, wvmid, async_req=True)
            >>> result = thread.get()
        ...
        self.get_wmv_es_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/d/{did}/{wvm}/{wvmid}/e",
                "operation_id": "get_wmv_es_metadata",
                "http_method": "GET",
                "servers": [],
            },
            params_map={
                "all": ["did", "wvm", "wvmid", "link_document_id", "infer_metadata_owner", "depth", "thumbnail"],
            ...
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
            callable=__get_wmv_es_metadata,
        )

        def __get_wmve_metadata(self, did, wvm, wvmid, eid, **kwargs):
        ...
        self.get_wmve_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/d/{did}/{wvm}/{wvmid}/e/{eid}",
            ...
            headers_map={"accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"], "content_type": []},
            api_client=api_client,
            callable=__get_wmve_metadata,
        )

        def __get_wmve_ps_metadata(self, did, wvm, wvmid, eid, **kwargs):
        ...
        self.get_wmve_ps_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/d/{did}/{wvm}/{wvmid}/e/{eid}/p",
                "operation_id": "get_wmve_ps_metadata",
                "http_method": "GET",
                "servers": [],
            },
            params_map={
        ...
        def __get_wmvep_metadata(self, did, wvm, wvmid, eid, pid, **kwargs):
        ...
        self.get_wmvep_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/d/{did}/{wvm}/{wvmid}/e/{eid}/p/{pid}",
            ...
            params_map={
                ...
                "required": ["did", "wvm", "wvmid", "eid", "pid"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __get_wv_metadata(self, did, wv, wvid, **kwargs):
        ...
        self.get_wv_metadata = Endpoint(
            settings={
                "response_type": None,
                "auth": ["OAuth2"],
                "endpoint_path": "/api/metadata/d/{did}/{wv}/{wvid}",
                "operation_id": "get_wv_metadata",
                "http_method": "GET",
                "servers": [],
            },
            params_map={
                "all": ["did", "wv", "wvid", "link_document_id", "infer_metadata_owner", "depth", "thumbnail"],
        ...
        def __update_veop_standard_content_part_metadata(self, did, vid, eid, otype, oid, pid, body, **kwargs):
        ...
        self.update_veop_standard_content_part_metadata = Endpoint(
            ...
            params_map={
                "all": ["did", "vid", "eid", "otype", "oid", "pid", "body", "link_document_id"],
                "required": ["did", "vid", "eid", "otype", "oid", "pid", "body"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __update_wv_metadata(self, did, wv, wvid, body, **kwargs):
        ...
        self.update_wv_metadata = Endpoint(
            ...
            params_map={
                "all": ["did", "wv", "wvid", "body"],
                "required": ["did", "wv", "wvid", "body"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            root_map={
                "validations": {},
                "allowed_values": {},
                "openapi_types": {"did": (str,), "wv": (str,), "wvid": (str,), "body": (str,)},
                "attribute_map": {"did": "did", "wv": "wv", "wvid": "wvid"},
                "location_map": {"did": "path", "wv": "path", "wvid": "path", "body": "body"},
                "collection_format_map": {},
            },
            headers_map={
                "accept": ["application/vnd.onshape.v1+json;charset=UTF-8;qs=0.1"],
        ...
        def __update_wve_metadata(self, did, wvm, wvmid, eid, body, **kwargs):
        ...
        self.update_wve_metadata = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "body", "configuration"],
                "required": ["did", "wvm", "wvmid", "eid", "body"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
        ...
        def __update_wvep_metadata(self, did, wvm, wvmid, eid, pid, sub_resource, body, **kwargs):
        ...
        self.update_wvep_metadata = Endpoint(
            ...
            params_map={
                "all": ["did", "wvm", "wvmid", "eid", "pid", "sub_resource", "body", "configuration"],
                "required": ["did", "wvm", "wvmid", "eid", "pid", "sub_resource", "body"],
                "nullable": [],
                "enum": [],
                "validation": [],
            },
            ...
            api_client=api_client,
            callable=__update_wvep_metadata,
        )
