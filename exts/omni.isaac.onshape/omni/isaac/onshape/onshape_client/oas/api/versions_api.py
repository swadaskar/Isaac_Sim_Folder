...
class VersionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __test_versions_get(self, **kwargs):
            """test_versions_get  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.test_versions_get(async_req=True)
            >>> result = thread.get()
        ...
        self.test_versions_get = Endpoint(
            settings={
                "response_type": None,
                "auth": [],
                "endpoint_path": "/api/versions/test",
                "operation_id": "test_versions_get",
                "http_method": "GET",
                "servers": [],
            },
            params_map={"all": ["body"], "required": [], "nullable": [], "enum": [], "validation": []},
            root_map={
                "validations": {},
                "allowed_values": {},
            ...
            callable=__test_versions_get,
        )

        def __test_versions_post(self, **kwargs):
            """test_versions_post  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.test_versions_post(async_req=True)
            >>> result = thread.get()
        ...
        self.test_versions_post = Endpoint(
            settings={
                "response_type": None,
                "auth": [],
                "endpoint_path": "/api/versions/test",
                "operation_id": "test_versions_post",
                "http_method": "POST",
                "servers": [],
            },
            params_map={"all": ["body"], "required": [], "nullable": [], "enum": [], "validation": []},
