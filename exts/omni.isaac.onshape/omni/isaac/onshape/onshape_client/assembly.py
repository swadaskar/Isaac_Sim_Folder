...
from omni.isaac.onshape.onshape_client.oas import BTAssemblyInstanceDefinitionParams, TransformGroup
...
class AssemblyDefinition:
    ...
    def get_occurrence_transforms(self, occurrence_path):
        ...
        return [occ["transform"] for occ in self.occurrences if occ["path"] == occurrence_path]
    ...
    def make_transform_group(self, occurrence_path):
        ...
        if "documentVersion" in instance:
            ...
            and instance["documentMicroversion"] == self.assembly_definition["rootAssembly"]["documentMicroversion"]
        ):
            assert self.origin_element and self.origin_element.wvm == "v"
            doc_version = self.origin_element.wvmid
        else:
            raise UserWarning("An assembly with linked documents needs to reference versions.")
    ...
    def is_structurally_equal_assembly(self, other):
        ...
        for occ in other.occurrences:
            ...
            for potential_occ in occurrences_to_be_matched:
                ...
                if (
                    AssemblyDefinition.is_equal_element_content(potential_instance, instance_to_match)
    ...
    def is_equal_element_content(this, other):
        return (
            ...
            and AssemblyDefinition.compare_configurations(this["configuration"], other["configuration"])
        )
